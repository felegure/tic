...
?>
    <div class="container">
            <div class="row">
                <h3>Type de Logiciel</h3>
            </div>
            <div class="row">
                <p>
                   <a href="create_general.php?form_name=index_softwarestype.php&table_name=tictan_softwaretypes&entete=Famille Logiciel" class="btn btn-success">Ajout Famille Logiciel</a>				
                </p>
                <table class="table table-striped table-bordered">
                      <thead>
                        <tr>
						  <th>Famille logiciel</th>		  
                          <th>Commentaire</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                      <?php
		              $table_name='tictan_softwaretypes';
					  $form_name='index_softwarestype.php';
					  $entete='Type de Logiciel';	
                      include 'database.php';
                       $pdo = Database::connect();					   

				   $sql = 'select * from tictan_softwaretypes where is_deleted=0 order by name';	
