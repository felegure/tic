...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_softwares.php&table_name=tictan_sofwaremodels&entete=Logiciel" class="btn btn-success">Nouveau logiciel</a>				
                </p>
                <table class="table table-striped table-bordered">
				   ...
				   $sql = 'select * from tictan_softwaremodels where is_deleted=0 order by name DESC';	
							...
							echo '<td>'. $row['comment'] . '</td>';						
   							echo '<td width=250>';
                            echo '<a class="btn" href="read_softwares.php?id='.$row['id'].'">Voir</a>';
                            echo ' ';
