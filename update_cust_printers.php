...
//	 		echo "                       2.  id=$id <br>";
    ...
    if ( null==$id  ) {
	   ...
	   if ( !empty($_POST)) {
 //     echo "dans POST <br> ";
    	require 'checkFields_cust_upd_printers.php';
		
        // update data
        if ($valid) {		
//		echo "valid???????????????????? <br>";
        require 'init_fields_upd_printers.php';
        require 'maj_fields_upd_valid_printers.php';
} 
} 

else {
        require 'maj_fields_upd_else_post_printers.php';
//	
...
<title>Modification imprimante</title>
<style type="text/css">
<!--
.Style25 {
	font-size: 16px;
...
<body>
    ...
    <div class="row" align="center">
      <h3>Modification Imprimante</h3>
    </div>
  <form class="form-actions" action="update_cust_printers.php?id=<?php echo $id?>" method="post">
	...
	<td width="80" height="42" align="right" nowrap ><div align="center" class="Style23">
	 <div align="center"><span class="Style22">Modele:<span class="Style21"></span></div>
	  <p> </p>
       ...
       <td width="80">
        <dd>
	  <input name="coprintersmodels_id2" type="text" align="right" readonly="true" value="<?php echo $data['namemodel']; ?>">    
	   <input name="coprintersmodels_id0" type="hidden" align="right" readonly="true" value="<?php echo $data['coprintersmodels_id']; ?>">    
      </dd>
			            ...
			            <input name="coprintersmodels_id0" type="hidden" value="<?php echo $coprintersmodels_id;?>">			
						</dd>						
    </div>
    </td>
	 ...
	 <td width="80">
	   <dd>
	  <input name="coprinterstypes_id2" type="text" align="right" readonly="true" value="<?php echo $data['nametype']; ?>">    
      <input name="coprinterstypes_id0" type="hidden" align="right" readonly="true" value="<?php echo $data['coprinterstypes_id']; ?>">    
      </dd>
		<dd>
		 <?php
		 $conn = mysqli_connect("localhost", "root", "") or die('Error connecting to MySQLserver.');
	   ...
	   <input name="coprintersypes_id0" type="hidden" value="<?php echo $coprinterstypes_id;?>">	
    </div>
    </td>
 </tr>
   <tr valign="baseline">
