...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_copiersmodel.php&table_name=tictan_copiersmodels&entete=Modele Photocopieur" class="btn btn-success">Nouveau modele de Photocopieur</a>				
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
			          $table_name='tictan_copiersmodels';
					  $entete='Modele Photocopieur';	
                      $form_name='index_copiersmodel.php';					  
                      include 'database.php';
                       $pdo = Database::connect();					   

				   $sql = 'select * from tictan_copiersmodels where is_deleted=0 order by name';	
