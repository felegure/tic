...
<body>
<form class="form-horizontal" name=f1 action="check_entities.php?nomprog=M" method="post">  
...
<div class="container">
	...
	<div class="control-group <?php echo !empty($entities_idError)?'error':'';?>">
			...
			echo '<a href="create_cust_monitor.php" class="btn btn-success">Ajout nouvel ecran</a>';
			else
			echo '<a href="create_cust_monitors.php" onClick="ValidateON()" class="btn btn-success">Nouvel écran</a>';
            ?>	
