...
// recuperation des variables de ssion pour le passage de parametres d'une forme a une autre
   ...
   include 'database.php';
	...
	if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE tictan_cust_com_disk  SET is_deleted=1 WHERE id =".$id;
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form name="delete_cust_disks" class="form-horizontal" action="delete_cust_disks.php" method="post">
