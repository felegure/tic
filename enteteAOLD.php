...
<div id="mbmcpebul_wrapper" style="max-width: 940px;">
  ...
  <li><div class="buttonbg gradient_button gradient27" style="width: 120px;border:1px solid black "><div class="arrow"><a>Parc/Client</a></div></div>
	...
	<li class="gradient_menuitem gradient31 last_item"><a href="index_computers.php" title="">Ordinateurs</a>
	 <ul class="gradient_menu gradient95">
	    <li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=computers&nom=ordinateur" title="">Modèle</a></li>
		<li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=type&objet=computers&nom=ordinateur" title="">Type</a></li>
		
		</ul>	
	 </li>
	<li class="gradient_menuitem gradient31 last_item"><a href="index_monitors.php" title="">Ecrans</a>
	<ul class="gradient_menu gradient95">
	    <li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=monitors" title="">Modèle</a></li>
		<li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=monitors"title="">Type</a></li>
	 </ul>	
	</li>
	<li class="gradient_menuitem gradient31 last_item"><a href="index_printers.php" title="">Imprimantes</a>
	 <ul class="gradient_menu gradient95">
	    <li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=printers" title="">Modèle</a></li>
		<li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=type&objet=printers" title="">Type</a></li>
	 </ul>	
	</li>
	<li class="gradient_menuitem gradient31 last_item"><a href="index_copiers.php" title="">Photocopieurs</a>
	 <ul class="gradient_menu gradient95">
	    	    <li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=copiers" title="">Modèle</a></li>
		<li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=type&objet=copiers" title="">Type</a></li>
	 </ul>	
	</li>
	<li class="gradient_menuitem gradient31 last_item"><a href="index_networks.php" title="">Réseaux</a>
     <ul class="gradient_menu gradient95">
	    <li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=networks" title="">Modèle</a></li>
		<li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=type&objet=networks" title="">Type</a></li>
	 </ul>	
	</li>
	<li class="gradient_menuitem gradient31 last_item"><a href="index_softwares.php" title="">Logiciels</a>
	 <ul class="gradient_menu gradient95">
	    <li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=software" title="">Modèle</a></li>
		<li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=type&objet=software" title="">Type</a></li>
	 </ul>	
	</li>
	<li class="gradient_menuitem gradient31 last_item"><a href="index_accessories.php" title="">Accessoires</a>
	 <ul class="gradient_menu gradient95">
	    <li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=model&objet=softwares" title="">Modèle</a></li>
		<li class="gradient_menuitem gradient31 last_item"><a href="index_objet.php?type=type&objet=softwares" title="">Type</a></li>
	 </ul>	
	</li>
    </ul></li>
