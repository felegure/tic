...
<form class="form-actions" method="post" name="create_cust_contacts" action="create_cust_contacts.php?customers_id=<?php echo $customers_id;?>
&entities_id=<?php echo $entities_id; ?>&companyname=<?php echo $companyname;?>" method="post" > 
...
<tr valign="baseline">
 ...
 <a class="btn" href="index_cust_create_contact.php?entities_id=$entities_id&companyname=$companyname">Retour</a>
	  </td>  
 </tr> 
  </table>
 </form>
