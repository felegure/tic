...
//echo "profil dans RapList_copiers.php = $profil <br>";
...
<title>Rapport Liste Photocopieurs</title>
 <meta charset="utf-8">
...
<td class='Header0_0' rowspan=1 colspan=4>Liste des Photocopieurs</td></tr>
...
<td class='Header2_1' rowspan=1 colspan=1>Nom Photocopieur</td>
...
<td class='Header2_15' rowspan=1 colspan=1>users_id</td></tr>
  ...
  <?php
       ...
       $pdo = Database::connect();
		...
		$sql_view = "SELECT * FROM vtictan_customers_copiers
	  ...
	  $save_id = 0;
		 ...
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namecopiers']. '</td>';		 
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namemodel']. '</td>';
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['nametype']. '</td>';	 
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['serial_copiers']. '</td>';
