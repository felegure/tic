                      ...
                      <div class="control-group">
					   ...
					   <div class="control-group">
                        ...
                        <div class="form-actions">
                          <a class="btn" href="check_entities.php?nomprog=C&entities_id=$entities_id">Retour</a>
						   <input name="entities_id" type="text" readonly="true" value="<?php echo $data['entities_idcust'];?>"
                       </div>
