...
//	echo "apres session name=$name <br>";
	...
	if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE tictan_cust_comp_soft SET is_deleted=1 WHERE id =".$id;
//	    echo "SUBMIT <br> sql=$sql <br>";
		
        $q = $pdo->prepare($sql); 
        $q->execute(array($id));
		$sql1 = "select * from vtictan_cust_comp_soft where id=".$id;
...
//		echo "companyname=$companyname <br>";
		header ("Location: index_cust_comp_softs.php?entities_id=$entities_id&companyname=$companyname&computers_id=$computers_id&type=softwares");
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form name="delete_cust_comp_virtuels" class="form-horizontal" action="delete_cust_comp_softs.php?id=<?php echo $id; ?>&pcname=<?php echo $pcname; ?>&entities_id=<?php echo $entities_id; ?>&companyname=<?php echo $companyname; ?>&customers_id=<?php echo $customers_id; ?>" method="post">
