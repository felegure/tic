...
<body>
<form class="form-horizontal" name="index_cust" action="check_entities.php?nomprog=customers" method="post">  
...
//	echo "EMPTY entities_id=$entities_id <br>";	
	include 'database.php';				
	$pdo = Database::connect();
...
//				  echo " index_cust ====>  profil = $profil entities_id=$entities_id<br>";
                  ...
                  foreach ($pdo->query($sql) as $row) {
                      ...
                      echo ' ';
                      echo '<a class="btn btn-danger" href="delete_customers.php?customers_id='.$row['id'].'">Supprimer</a>';
					  }
					  echo '</td>';
                      echo '</tr>';
                      }
