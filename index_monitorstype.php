...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_monitorstype.php&table_name=tictan_monitortypes&entete=type Moniteur" class="btn btn-success">Nouveau type moniteur</a>				
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
					  $table_name='tictan_monitortypes';
					  $form_name='index_monitorstype.php';
					  $entete='Type Moniteur';
                      include 'database.php';
                      $pdo = Database::connect();					   

				       $sql = 'select * from tictan_monitortypes where is_deleted=0 order by name';	
