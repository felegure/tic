...
?>
    ...
    <div class="container">
            <div class="row">
                <h4>Gestion des imprimantes/Site</h3>
            </div>
            <div class="row">
...
echo '<td>'.'<a href="printer_list.php?customer_id='.$row['idencust'].'&customer_name='.$row["customer_name"].'&entities_id='.$row['entities_id'].'&companynament='.$row['companynament'].'&first=0'.'">'. $row["customer_name"]. '</a>'. '</td>';	
                            echo ' ';			
