...
<body>
<form class="form-horizontal" name=f1 action="check_entities.php?nomprog=P" method="post">  
...
<div class="container">
    ...
    <div class="container">
            <div class="row">
                <h3>Gestion des imprimantes/Site</h3>
	...
	<div class="control-group <?php echo !empty($entities_idError)?'error':'';?>">
			...
			echo '<a href="create_cust_printers.php" class="btn btn-success">Ajout nouvelle imprimante</a>';
			else
			echo '<a href="create_cust_printers.php" onClick="ValidateON()" class="btn btn-success">Nouvelle ,imprimante</a>';
            ?>	
