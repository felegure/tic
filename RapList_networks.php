...
//echo "profil dans RapList_networks.php = $profil <br>";
...
<title>Rapport Liste Réseaux</title>
 <meta charset="utf-8">
...
<td class='Header0_0' rowspan=1 colspan=4>Liste des equipements réseaux</td></tr>
...
<tr><td class='Header2_0' rowspan=1 colspan=1>Nom Client</td><td class='Header2_1' rowspan=1 colspan=1>Nom équipement</td><td class='Header2_2' rowspan=1 colspan=1>Modèle</td><td class='Header2_3' rowspan=1 colspan=1>Type</td><td class='Header2_4' rowspan=1 colspan=1>N° série</td><td class='Header2_5' rowspan=1 colspan=1>Adresse ip</td><td class='Header2_5' rowspan=1 colspan=1>Type adressage</td><td class='Header2_5' rowspan=1 colspan=1>connexion via</td>
<td class='Header2_5' rowspan=1 colspan=1>Localisation</td><td class='Header2_6' rowspan=1 colspan=1>Utilisateur</td></tr>
 
  <?php
       include_once ('database.php');
       $pdo = Database::connect();
        $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$sql_view = "SELECT * FROM vtictan_customers_network 
	  ...
	  $save_id = 0;
		 ...
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namenetwork']. '</td>';		 
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namemodel']. '</td>';
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['nametype']. '</td>';	 
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['serial_network']. '</td>';
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['adresseip']. '</td>';	
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['typeadressage']. '</td>';	
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['connexionvia']. '</td>';		 
