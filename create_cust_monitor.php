...
//	echo "create_cust_computers.php customer_id = $customer_id , customer_name = $customer_name <br>";

    require 'database.php';
    $pdo = Database::connect();
	$profil = $_SESSION['profilAccess'];
    if ($profil != 'A' && $profil != 'S') 
	header("Location: index_cust_monitor.php");
    if ( !empty($_POST)) {
        // keep track validation errors
         ...
         if ($valid) {
            ...
            $q = $pdo->prepare($sql);
            $q->execute(array($customer_id, $entities_id, $serial, $name, $monitormodels_id, $monitortypes_id,
			$location, $users_id, $groups_id, $comment, $author, $date_mod,$is_deleted ));
            Database::disconnect();
            header("Location: index_cust_monitors.php");
        }
    }
?>
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Ajouter un ecran/Site</h3>
                    </div>            
                    <form class="form-horizontal" action="create_cust_monitor.php" method="post">  
					...
					<label class="control-label">Id ecran</label>
                        <div class="controls">
                            <input name="name" type="text" placeholder="nom ecran" size=40 value="<?php echo !empty($name)?$name:'';?>">
						...
						<div class="control-group <?php echo !empty($monitormodels_idError)?'error':'';?>">
	                 ...
	                 <div class="control-group <?php echo !empty($monitortypes_idError)?'error':'';?>">
					...
					<label class="control-label">Numero de serie</label>
                      ...
                      <div class="form-actions">
                          ...
                          <a class="btn" href="index_cust_monitors.php">Retour</a>
                        </div>
                    </form>
                </div>
