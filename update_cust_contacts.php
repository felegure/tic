<?php
 ...
 //    $id  = $_REQUEST['id'];
       $contacts_id=$_SESSION['contacts_id'];
//	 	echo " 2.  contacts_id=$contacts_id <br>";			
    }
    if ( null==$contacts_id ) {
	echo "NULL == contacts_id<br>";
 //       header("Location: contact_all_list.php");
    }
	
	if (!empty($_POST)) {
 //    echo "dans POST <br> ";
    	require 'checkFields_upd_contacts.php';
        // update data
        if ($valid) {		
//		echo "valid???????????????????? <br>";
        require 'init_fields_upd_contacts.php';
        require'maj_fields_upd_valid_contacts.php';
} 
} 
else {
 //        echo "Pas dans POST customers_id=$customers_id <br><br>";
        require 'maj_fields_upd_else_post_contacts.php';
}
    ...
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row" align="center" >
                        <h3> Modification Contact/Client</h3>
                    </div>    

<form class="form-actions" method="post" name="update_cust_contacts" action="update_cust_contacts.php?contacts_id=<?php echo $contacts_id?>" method="post" > 
