    ...
    <div class="container">
            ...
            <div class="row">
				...
				if ($_SESSION['profilAccess'] == 'A' || $_SESSION['profilAccess'] == 'S') 		
     			echo ' <a href="create_contact.php?entities_id=$entities_id&companynament=$companynament&customers_id=$customer_id&customer_name=$customer_name" class="btn btn-success">Nouveau Contact</a>';
	    		else
		    	echo '<a href="create_contact.php?entities_id=$entities_id&companynament=$companynament&customer_id=$customer_id&customer_name=$customer_name" onClick="ValidateON()" class="btn btn-success">Nouveau Contact</a>';
                ?>
				</p>
