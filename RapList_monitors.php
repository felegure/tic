...
//echo "profil dans RapList_monitors.php = $profil <br>";
...
<title>Rapport Liste écrans</title>
 <meta charset="utf-8">
...
<td class='Header0_0' rowspan=1 colspan=4>Liste des écrans</td></tr>
...
<tr><td class='Header2_0' rowspan=1 colspan=1>Nom Client</td><td class='Header2_1' rowspan=1 colspan=1>Nom écran</td><td class='Header2_2' rowspan=1 colspan=1>Modèle</td><td class='Header2_3' rowspan=1 colspan=1>Type</td><td class='Header2_4' rowspan=1 colspan=1>N° série</td><td class='Header2_14' rowspan=1 colspan=1>Localisation</td><td class='Header2_15' rowspan=1 colspan=1>users_id</td></tr>

  <?php
       include_once ('database.php');
       $pdo = Database::connect();
        $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$sql_view = "SELECT * FROM vtictan_customers_monitors
	     order by id_monitor";
	  ...
	  $save_id = 0;
		 ...
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namemonitor']. '</td>';		 
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namemodel']. '</td>';
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['nametype']. '</td>';	 
 		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['serial_monitor']. '</td>';				 
