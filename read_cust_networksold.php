...
<?php
 ...
 if ( null==$id ) {
        header("Location: index_cust_choose.php?entities_id=$entities_id&customers_id=$customer_id&customer_name=$customer_name&$type=networks");
    } else {
             ...
             <thead>
     		   <div class="form-horizontal" >
                  ...
                  <div class="form-actions">
                          <a class="btn" href="index_cust_choose.php?type=networks&entities_id=<?php echo $entities_id ?> &customer_id=<?php echo $data['customers_id'] ?>
						  &customer_name=<?php echo $data['customer_name'] ?>">Retour</a>
                       </div>
 	               </form>	    
