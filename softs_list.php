...
?>			
 ...
 // echo "sql = $sql <br>";
  ...
  echo '<td width=250>';
  echo '<a class="btn btn-success" href="index_cust_comp_softs.php?computers_id='.$row['id'].'&computer_name='.$row['pcname'].'&customer_name='.$row['customer_name'].'&customers_id='.$row['customers_id'].'">Liste des logiciels</a>';  // parametres entities_id, customer_id, computers_id
  echo '</td>';
  echo '</tr>';
...
<table  width="900" height="30" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#ECE9D8" frame="border">
 <tr valign="baseline">
  ...
  <a class="btn" align="right"  href="index_cust_choose.php?entities_id=<?php echo $entities_id; ?>&type=softwares">Retour</a>
	  </td>  
 </tr> 
  </table>	
