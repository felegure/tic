...
//echo "profil dans RapList_softwares.php = $profil <br>";
...
<title>Rapport Liste logiciels</title>
 <meta charset="utf-8">
...
<td class='Header0_0' rowspan=1 colspan=4>Liste des logiciels</td></tr>
...
<td class='Header2_1' rowspan=1 colspan=1>Nom software</td>
<td class='Header2_2' rowspan=1 colspan=1>Modèle</td>
<td class='Header2_3' rowspan=1 colspan=1>Type</td>
<td class='Header2_4' rowspan=1 colspan=1>N° licence</td>
<td class='Header2_11' rowspan=1 colspan=1>Editeur</td>
<td class='Header2_12' rowspan=1 colspan=1>Fournisseur</td>
<td class='Header2_15' rowspan=1 colspan=1>users_id</td></tr>
  ...
  <?php
       ...
       $pdo = Database::connect();
		...
		$sql_view = "SELECT * FROM vtictan_customers_software
	  ...
	  $save_id = 0;
		 ...
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namesoft']. '</td>';		 
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['namemodel']. '</td>';
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['nametype']. '</td>';	 
		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['licencesoft']. '</td>';
 		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['editorsoft']. '</td>';	
 		 echo '<td class='.'Detail0_0'. ' '.' rowspan=1 colspan=1>'.$row['suppliersoft']. '</td>';				 
