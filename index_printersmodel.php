...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_printersmodel.php&table_name=tictan_coprintersmodels&entete=Modele Imprimante" class="btn btn-success">Nouveau modele d'imprimante</a>				
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
		              $table_name='tictan_coprintersmodels';
					  $form_name='index_printersmodel.php';
					  $entete='Modele Imprimante';				  
                      include 'database.php';
                       $pdo = Database::connect();					   
				       $sql = 'select * from tictan_coprintersmodels where is_deleted=0 order by name';			
