<?php
 ...
 //   echo "Avant POST <br>";  
  ...
  //   echo "Apres POST <br>";          
        ...
        $sql = "UPDATE tictan_customers  SET is_deleted=1 WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
        Database::disconnect();
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="delete_cust.php" method="post">
                      <input type="hidden" name="id" value="<?php echo $id;?>"/>
                      <p class="alert alert-error">Confirmer la suppression du Site/Client ?</p>
                      <div class="form-actions">
                          <button type="submit" class="btn btn-danger">Oui</button>
                          <a class="btn" href="index_cust.php">Non</a>
                        </div>
                    </form>
                </div>
