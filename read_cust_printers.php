...
<?php
 ...
 if ( null==$id ) {
        header("Location: index_cust_choose.php?type=printers");
    } else {
...
//		echo "companynament=$companynament <br>";
		$_SESSION["companyname"] = $data['companynament'];
 ...
 <div class="container"> 
                <div class="span10 offset1">
                    <div class="row" align="center">
                        <h3>Details de l'imprimante</h3>
                    </div>   
<form class="form-actions" method="post" name="read_cust_printers" > 
