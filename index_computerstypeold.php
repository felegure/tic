...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_computerstype.php&table_name=tictan_computertypes&entete=Type Ordinateur" class="btn btn-success">Nouveau type ordinateur</a>
                </p>
