...
?>
    <div class="container">
            <div class="row">
                <h3>Equipement Reseau</h3>
            </div>
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_networksmodel.php&table_name=tictan_networkmodels&entete=Modele equipement Reseau" class="btn btn-success">Nouvel equipement Reseau</a>								
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
		              $table_name='tictan_networkmodels';
					  $form_name='index_networksmodel.php';
					  $entete='Modèle Equipement Réseau';			  			  
                      include 'database.php';
                      $pdo = Database::connect();					   

				   $sql = 'select * from tictan_networkmodels where is_deleted=0 order by name';	
