...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_monitorsmodel.php&table_name=tictan_monitormodels&entete=Modele Moniteur" class="btn btn-success">Nouveau model moniteur</a>				
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
		              $table_name='tictan_monitormodels';
					  $form_name='index_monitorsmodel.php';
					  $entete='Modele Moniteur';			  
                      include 'database.php';
                       $pdo = Database::connect();					   

				       $sql = 'select * from tictan_monitormodels where is_deleted=0 order by name';	
