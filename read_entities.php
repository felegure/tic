<?php
    ...
    if ( null==$id ) {
        ...
        $sql = "SELECT * FROM tictan_entities where id =".$id;
//				echo "sql=$sql <br>";	
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
...
<form class="form-actions" method="post" name="read_entities" action="read_entities.php" method="post" > 
  ...
  <table  width="900" height="300" border="1" align="center" cellpadding="1" cellspacing="1" bgcolor="#ECE9D8" frame="border">
   ...
   <tr valign="baseline">
      ...
      <td width="200">
	  <dd>
	  	<input name="vatcode" type="text"  readonly="true" placeholder="vatcode" value="<?php echo $data['vatcode'];?>">					
      </dd>
	  </td> 
    </tr>
	 ...
	 <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
	   ...
	   <td width="200">
	   <dd>
	  	<input name="account1" type="text" readonly="true" placeholder="Numero de compte (1)" value="<?php echo $data['account1'];?>">		
	   </dd>
      </td>
    ...
    <td width="400">
	<dd>
		<input name="account2" type="text" readonly="true" placeholder="Numero de compte (2)" value="<?php echo $data['account2'];?>">						
	</dd>
      </td > 
</tr>
<tr valign="baseline">
	 ...
	 <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
	   ...
	   <td width="200">
	   <dd>
	  	 <input name="address" type="text" readonly="true" placeholder="Adresse" size="40" value="<?php echo $data['address'];?>">
    ...
    <td width="400">
	<dd>
 <input name="town" type="text"readonly="true"  placeholder="Localite" size="30" value="<?php echo $data['town'];?>">		
	</dd>
      </td > 
</tr>
<tr valign="baseline">
	 ...
	 <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
	   ...
	   <td width="200">
	   <dd>
    <input name="postcode" type="text"readonly="true"  placeholder="Code postal" value="<?php echo $data['postcode'];?>">			
	   </dd>
      </td>
    ...
    <td width="400">
	<dd>
        <input name="country" type="text" readonly="true" placeholder="Pays" value="<?php echo $data['country'];?>">
	</dd>
      </td > 
</tr>
...
<tr valign="baseline">
	 ...
	 <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
	   ...
	   <td width="200">
	   <dd>
 <input name="phone" type="text" readonly="true" placeholder="Telephone" value="<?php echo $data['phone'];?>">				
	   </dd>
      </td>
...
<tr valign="baseline">
	 ...
	 <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
	   ...
	   <td width="200">
	   <dd>
   <input name="mobile" type="text" readonly="true" placeholder="Gsm" value="<?php echo $data['mobile'];?>">				
	   </dd>
      </td>
 </tr> 
 <tr valign="baseline">
	 <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
	   ...
	   <td width="200">
	   <dd>
        <input name="email" type="text" readonly="true" placeholder="Email Address" value="<?php echo $data['email'];?>">				
	   </dd>
      </td>
    ...
    <td width="400">
	<dd>
   <input name="website" type="text" readonly="true" placeholder="Site web" value="<?php echo $data['website'];?>">				
	</dd>
      </td > 
</tr>
<tr valign="baseline">
	 ...
	 <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
	   ...
	   <td width="200">
	   <dd>
	  	 <input name="comment" type="textarea" size="200" readonly="true" placeholder="Commentaire" value="<?php echo $data['comment'];?>">			
	   </dd>
      </td>
 ...
 <tr valign="baseline">
      ...
      <a class="btn" href="entities_all_list.php">Retour</a>
	  </td>  
 </tr> 
  </table>
 </form>
