...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_accessoriestype.php&table_name=tictan_accessoriestypes&entete=Accessoire" class="btn btn-success">Nouveau Type Accessoire</a>
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
		              $table_name='tictan_accessoriestypes';
					  $form_name='index_accessoriestype.php';
					  $entete='Type Accessoires';			  			  
                      include 'database.php';
                      $pdo = Database::connect();					   

				   $sql = 'select * from tictan_accessoriestypes where is_deleted=0 order by name';	
