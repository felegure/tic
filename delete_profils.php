...
session_start(); 
  ...
  $id = 0;
	 ...
	 if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE tictan_profil   SET is_deleted=1 WHERE id =".$id;
    ...
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row" align="center">
                        <h3>Suppression d'un profil</h3>
                    </div>
                     
                    <form class="form-horizontal" action="delete_profils.php" method="post">
                      ...
                      <div class="form-actions" align="center">
                          ...
                          <a class="btn" href="index_profils.php">Non</a>
                        </div>
                    </form>
                </div>
