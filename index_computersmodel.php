...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_computersmodel.php&table_name=tictan_computermodels&entete=Modele Ordinateur" class="btn btn-success">Nouvel ordinateur</a>
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
					  $table_name='tictan_computermodels';
					  $form_name='index_computersmodel.php';
					  $entete='Modele Ordinateur';
                      include 'database.php';
                       $pdo = Database::connect();					   

				   $sql = 'select * from tictan_computermodels where is_deleted=0 order by name';	
