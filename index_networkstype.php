...
?>
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="create_general.php?form_name=index_networkstype.php&table_name=tictan_networktypes&entete=type equipement Reseau" class="btn btn-success">Nouveau Type equipement Reseau</a>								
                </p>
                <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php
		              $table_name='tictan_networktypes';
					  $form_name='index_networkstype.php';
					  $entete='Type Equipement Réseau';			  			  				  
                      include 'database.php';
                       $pdo = Database::connect();					   

				   $sql = 'select * from tictan_networktypes where is_deleted=0 order by name';	
