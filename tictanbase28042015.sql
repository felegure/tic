...
--
-- Client: localhost
-- Généré le: Mar 28 Avril 2015 à 10:51
...
(28, 'sd', 'dfs', 'dfs', 'df', 'fnezzi@gmail.com', 'sdfdfs', '', 0, 'dss', 'sdf', 'sdf', NULL, 'sdf', 'admin', '0000-00-00', 11, 8),
(29, 'ISPAT ecole', '+3222197478', '04575 57 57', '+322 218 38 68', 'info@ispat.be', 'www.ispat.be', 'Test IPAT entite', 0, 'Rue de Bucarest, 55', '1210', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 11, 4),
...
--
-- Structure de la table `vtictan_customers_contacts`
--
-- utilisé(#1356 - View 'tictan.vtictan_customers_contacts' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
-- Erreur de lecture des données :  (#1356 - View 'tictan.vtictan_customers_contacts' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)

-- --------------------------------------------------------

--
-- Structure de la table `vtictan_customers_contacts_typename`
--
-- utilisé(#1356 - View 'tictan.vtictan_customers_contacts_typename' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
-- Erreur de lecture des données :  (#1356 - View 'tictan.vtictan_customers_contacts_typename' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
...
--
-- Structure de la table `vtictan_customers_group`
--
-- utilisé(#1356 - View 'tictan.vtictan_customers_group' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
-- Erreur de lecture des données :  (#1356 - View 'tictan.vtictan_customers_group' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
...
--
-- Structure de la table `vtictan_customers_users`
--
-- utilisé(#1356 - View 'tictan.vtictan_customers_users' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
-- Erreur de lecture des données :  (#1356 - View 'tictan.vtictan_customers_users' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
