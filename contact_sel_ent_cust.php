...
$quer2="SELECT DISTINCT companynament,id FROM tictan_entities order by companynament"; 
/////// for second drop down list we will check if category is selected else we will display all the subcategory///// 
if(isset($cat) and strlen($cat) > 0){
$quer="SELECT DISTINCT customer_name, FROM tictan_customers where id=$cat order by customer_name"; 
...
if($noticia2['id']==@$cat){echo "<option selected value='$noticia2[cat_id]'>$noticia2[category]</option>"."<BR>";}
