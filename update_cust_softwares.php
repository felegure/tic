...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="update_cust_softwares.php?id=<?php echo $id?>" method="post">
                     ...
                     <div class="form-actions">
                          ...
                          <a class="btn" href="software_list.php?entities_id=<?php echo $entities_id ?> &customer_id=<?php echo $data['customers_id'] ?>">Retour</a>
                        </div>			
                    </form>
                </div>
