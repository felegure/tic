...
--
-- Client: localhost
-- Généré le: Lun 06 Juillet 2015 à 11:46
...
--
-- Structure de la table `taccent`
--

CREATE TABLE IF NOT EXISTS `taccent` (
  `description1` varchar(255) COLLATE utf8_bin NOT NULL,
  `description2` varchar(255) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Contenu de la table `taccent`
--

INSERT INTO `taccent` (`description1`, `description2`) VALUES
('éèàê', 'éh£µ ù ');
...
INSERT INTO `tictan_accessoriesmodels` (`id`, `name`, `is_deleted`, `comment`, `author`, `date_mod`) VALUES
...
(6, 'Faux Clavier', 0, 'Vrai Clavier', 'admin', '0000-00-00');
...
INSERT INTO `tictan_accessoriestypes` (`id`, `name`, `comment`, `is_deleted`, `author`, `date_mod`) VALUES
...
(6, 'TYpe accessoire', 'AAAAAAAAAAAA', 1, 'admin', '0000-00-00'),
(7, 'Ajout Type accessoires', 'CCCCCCCCCCCCCCCCCCC', 1, 'admin', '0000-00-00');
...
INSERT INTO `tictan_computermodels` (`id`, `name`, `comment`, `date_mod`, `mod_date`, `author`, `is_deleted`) VALUES
(1, 'Ordinateur de bureau HP 110-314nb (ENERGY STAR)(J2H16EA)', NULL, '0000-00-00', '0000-00-00', '', 0),
(2, 'HP - 22-2017nb ordinateur tout-en-un (ENERGY STAR) (K2C63EA)', NULL, '0000-00-00', '0000-00-00', '', 0),
(3, 'HP ordinateur de bureau HP ENVY Phoenix h9-1360ez', NULL, '0000-00-00', '0000-00-00', '', 0),
(4, 'HP Envy laptop', NULL, '0000-00-00', '0000-00-00', '', 0),
(5, 'Inspiron Compact Serie 3000', '', '0000-00-00', '0000-00-00', '', 0),
(14, 'Optiplex 330 ', NULL, '0000-00-00', '0000-00-00', '', 0),
(15, 'Optiplex 745', NULL, '0000-00-00', '0000-00-00', '', 0),
(16, 'Optiplex 360', NULL, '0000-00-00', '0000-00-00', '', 0),
(17, 'Bon modele de test', 'Commenatire de test', '0000-00-00', '0000-00-00', 'admin', 1),
(6, 'Inspiron Compact Serie 3000 bis', 'Inspiron Compact Serie 3000\r\n340,64 euros\r\nProcesseur double coeur Intel Celeron\r\nProcesseur double coeur Intel Celeron\r\nWindows 8.1 with Bing\r\nWindows 8.1 with Bing\r\n4 Go de memoire\r\n4 Go de memoire\r\nDisque dur de 500 Go\r\nDisque dur de 500 Go\r\nOrdinateur de bureau d entree de gamme a un prix attractif, equipe de Windows 8.1 et accompagne d un ecran large 19,5"', '0000-00-00', '0000-00-00', '', 0),
(7, 'Inspiron 15 Série 5000 (laptop) bis', 'Inspiron 15 Serie 5000 (Intel) avec ecran tactile disponible sur certains modeles', '0000-00-00', '0000-00-00', '', 1),
(8, 'Inspiron 15 Serie 5000 (laptop)', 'Inspiron 15 Serie 5000 (Intel)\n649,00 euros\nProcesseur Intel Core i7 de 4e generation\nProcesseur Intel Core i7 de 4e generation\nWindows 8.1\nWindows 8.1\n8 Go de memoire\n8 Go de memoire\nDisque dur de 1 To\nDisque dur de 1 To', '0000-00-00', '0000-00-00', '', 0),
(11, 'HP - 22-2005nb ordinateur tout-en-un (ENERGY STAR) (K2A29EA)', NULL, '0000-00-00', '0000-00-00', '', 0),
(12, 'Le prix serveur le plus bas Avec le NOUVEAU systeme d exploitation Windows Server 2012 Foundation Disque dur 1 To et 3 ans de ProSupport  Ajouter pour comparer En savoir plusDell PowerEdge T110 II  Ajouter pour comparer En savoir plusDell PowerEdge T110', NULL, '0000-00-00', '0000-00-00', '', 0),
(13, 'Dell PowerEdge T320', NULL, '0000-00-00', '0000-00-00', '', 0),
(20, 'Dell Vostro 230 Intel ® Pentium ® Dual-core CPU E6500 @2.9GHZ', '', '0000-00-00', '0000-00-00', 'admin', 0),
(21, 'Dell Vostro 260 ST Intel® Pentium® CPU63220 3.30GHZ', '', '0000-00-00', '0000-00-00', 'admin', 0),
(22, 'Dell Vostro 270	Intel ®  Pentium  CPU G2030 @ 3.00GHZ', '', '0000-00-00', '0000-00-00', 'admin', 0),
(23, 'Dell Vostro V23MT', '', '0000-00-00', '0000-00-00', 'admin', 0),
(24, 'Dell Inspiron 1546', '', '0000-00-00', '0000-00-00', 'admin', 0),
(25, 'ordinateur avec ééé èèè $%', NULL, '0000-00-00', '0000-00-00', '', 1),
(26, 'ORDI', NULL, '0000-00-00', '0000-00-00', '', 0);
...
INSERT INTO `tictan_computertypes` (`id`, `name`, `comment`, `date_mod`, `author`, `is_deleted`) VALUES
...
(7, 'Type OrdianteurFFF', 'rAS', '0000-00-00', 'admin', 1);
...
--
-- Structure de la table `tictan_copiersmodels`
--

CREATE TABLE IF NOT EXISTS `tictan_copiersmodels` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comment` text COLLATE utf8_unicode_ci,
  `date_mod` date NOT NULL,
...
--
-- Contenu de la table `tictan_copiersmodels`
--

INSERT INTO `tictan_copiersmodels` (`id`, `name`, `comment`, `date_mod`, `author`, `is_deleted`) VALUES
(3, 'TASKalfa 5501i', 'Up to 55 pages per minute A4 in b/w\r\n    2 GB RAM, storage capacity of 160 GB HDD\r\n    Standard network printing and colour scanning\r\n    Expandable fax functions of dual fax, network fax, and internet fax\r\n    Optional scan to searchable PDF solution (OCR)\r\n    Individual paper-handling options including booklet and tri-folding\r\n    Comprehensive security functions including optional IC Card Reader\r\n    Long-life components provide unprecedented efficiency and reliability', '0000-00-00', '', 0),
(2, 'Multifonction SG 3120B SFNw', NULL, '0000-00-00', '', 0),
(4, 'Canon MAXIFY MB2050', 'Imprimantes jet d encre professionnelles', '0000-00-00', '', 0),
(5, 'Canon i-SENSYS MF8230Cn', '', '0000-00-00', '', 0),
(6, 'Aficio™MP 301SP', 'Multifonctions N&B A4 compacts de qualite superieure', '2015-02-10', '', 0),
(7, 'MP C6502SP', 'Caracteristiques et avantages\r\n\r\n    Impression ultra rapide\r\n\r\n    Haute qualite d''image\r\n\r\n    Un large choix de supports papier\r\n\r\n    Facile à utiliser\r\n\r\n    Accelerez vos flux de travaux ', '2015-02-10', '', 0),
(8, 'qsdfqsfqsdfqsd', 'sdfqsdfqsfdqsdf', '0000-00-00', 'admin', 0),
(9, 'Phocopier a effacer', 'Commenatire a effacer', '0000-00-00', 'admin', 0);
...
(3, 'All in One', '', '0000-00-00', 'admin', 0),
...
(8, 'pppppppppppppppppp', 'cccccccccccccccccccc', '0000-00-00', 'admin', 1);
...
--
-- Contenu de la table `tictan_coprintersmodels`
--

INSERT INTO `tictan_coprintersmodels` (`id`, `name`, `comment`, `date_mod`, `author`, `is_deleted`, `is_dynamic`) VALUES
(5, 'Lexmark 450', NULL, '2015-02-04 00:00:00', 'felicien', 0, 0),
(6, 'HP lasert 3450', NULL, '2015-02-04 00:00:00', 'nezzi', 0, 0),
(7, 'HP color serie 5000', NULL, '2015-02-04 00:00:00', 'nezzi', 0, 0),
(8, 'All in One HP 452', '', '0000-00-00 00:00:00', 'admin', 0, 0),
(9, 'HP J4680', NULL, '0000-00-00 00:00:00', '', 0, 0),
(10, 'Brother HL-2035', NULL, '0000-00-00 00:00:00', '', 0, 0),
(11, 'DELL V525w', NULL, '0000-00-00 00:00:00', '', 0, 0),
(12, 'HP 8500 Office JetPro', NULL, '0000-00-00 00:00:00', '', 0, 0),
(13, 'rera', 'zerazeréeazerazer', '0000-00-00 00:00:00', 'admin', 0, 0);
...
INSERT INTO `tictan_coprinterstypes` (`id`, `name`, `comment`, `is_deleted`, `date_mod`, `author`) VALUES
(4, 'Imprimante Noir et Blanc', NULL, 0, '2015-02-04', 'felicien'),
(5, 'Imprimante Couleur', NULL, 0, '2015-02-04', 'felicien'),
(6, 'All in One', '', 0, '0000-00-00', 'admin'),
(7, 'Imprimante bidon', 'Commenatire bidon', 1, '0000-00-00', 'admin');
...
INSERT INTO `tictan_customers` (`id`, `customer_name`, `phone`, `mobile`, `fax`, `email`, `website`, `comment`, `is_deleted`, `address`, `postcode`, `town`, `state`, `country`, `author`, `date_mod`, `entities_id`, `customtype_id`) VALUES
...
(20, 'Client 6 entite 4', '041 10 10 10 ', '0460 66 66 66 ', '041 10 10 11', 'client6@hotmail.com', 'www.entite4.com', 'RAS client 5 entite 4', 0, 'Rue client 6 , 52', '4000', 'Liege', 'PROVINCE DE LIEGE', 'Belgique', 'admin', '0000-00-00', 17, 7),
...
(23, 'ISPAT ecole NEW', '+3222197478', '04575 57 57', '+322 218 38 68', 'info@ispat.be', 'www.ispat.be', 'Test IPAT entite', 0, 'Rue de Bucarest, 55', '1210', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 24, 4),
(24, 'ISPAT ecole', '+3222197478', '04575 57 57', '+322 218 38 68', 'info@ispat.be', 'www.ispat.be', 'Test IPAT entite', 1, 'Rue de Bucarest, 55', '1210', 'Bruxelles', NULL, 'Belgiqueertertrtrt', 'admin', '0000-00-00', 24, 6),
(25, 'ISPAT ecole', '+3222197478', '04575 57 57', '+322 218 38 68', 'info@ispat.be', 'www.ispat.be', 'Test IPAT entite', 1, 'Rue de Bucarest, 55', '1210', 'Bruxelles', NULL, 'France', 'admin', '0000-00-00', 24, 6),
(26, 'ISPAT5', '02 365987452', '0484522669', '02 520 25 25', 'info@ispat.be', 'www.ispat.be', 'Cecie est un commentaire', 1, 'Rue adresse ISPAT5', '1210', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 24, 6),
(27, 'Felicien le magicien', '02 222 22222', '0484522669', '02 520 25 25', 'courriel@gmail.com', 'www.ispat.be', 'Commentaireb Felicien le Magicien', 0, 'Rue de la magie, 11', '4000', 'Liege', NULL, 'France', 'admin', '0000-00-00', 11, 6),
(28, 'sd', 'dfs', 'dfs', 'df', 'fnezzi@gmail.com', 'sdfdfs', '', 1, 'dss', 'sdf', 'sdf', NULL, 'sdf', 'admin', '0000-00-00', 11, 8),
(29, 'ISPAT ecole', '+3222197478', '04575 57 57', '+322 218 38 68', 'info@ispat.be', 'www.ispat.be', 'Test IPAT entite', 1, 'Rue de Bucarest, 55', '1210', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 11, 4),
(30, 'ISPAT DERNEIR', '+3222197478', '0484522669', '+322 218 38 68', 'ispatdernier@ispat.be', 'www.ispat.be', 'Commenaire Derneir ISPAT', 1, 'Rue de ISPAT DERNIER', '1000', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 24, 5),
(31, 'ISPAR NEW', '02 555 22 23', '0484522669', '+322 218 38 68', 'gui@gmail.com', 'www.ispat.be', 'commentaire', 1, 'new', '1000 new', 'new localite', NULL, 'Belgique', 'admin', '0000-00-00', 24, 6),
(32, 'ISPAT OLD', '02 4235753', '0484 52 26 69', '02 568 65 56', 'gui@gmail.com', 'www.cpas.be', 'Cecie est un commentaire', 1, 'adresse ISPAT OLD', '1230', 'localite OLD', NULL, 'Belgique', 'admin', '0000-00-00', 24, 5),
(33, 'é"&é', '&é"&é"&é"', '&é"é&"', '&é"&é"é&', 'é""é&é', '&é""', '"&"é', 1, '&é"é', '"&é"é', '&é"é&"', NULL, '&é"', 'admin', '0000-00-00', 19, 7),
(34, 'ISPAT ENCORE', '', '', '', '', '', '', 1, 'a', '', '', NULL, '', 'admin', '0000-00-00', 24, 8),
(35, 'ISPAT TOUJOPURS', 'd', 'd', 'd', 'd', 'd', 'd', 1, 'd', 'd', 'd', NULL, 'd', 'admin', '0000-00-00', 24, 6),
(36, 'test', '', '', '', '', '', '', 1, 'rue de asbl test, 54', 'test', 'test', NULL, '', 'admin', '0000-00-00', 24, 0),
(37, 'ISPAT FELEGURE', '02 555 22 23', '0484522669', '02', 'courriel@gmail.com', 'www.ispat.be', 'Commentaire Patien 2', 0, 'rue de lSPAT, 55', '1000', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 24, 6),
(38, 'Entite 4 NOM Client', '02 555 22 23', '0485623232', '02 520 25 25', 'courriel@gmail.com', 'www.ispat.be', 'YES YES', 0, 'AAAAAAAAAAAA', '1000', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 19, 0),
(39, 'Entite 4 NOM Client', '02 555 22 23', '0484522669', '02 520 25 25', 'courriel@gmail.com', 'www.gg.commmmmm', 'CCCCCCCCCCCCCCCCC', 0, 'Adresse ENtite 4', '1000', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 19, 4),
(40, 'ENtite 4 Pour enfantS GUERIS', '02 555 22 23', '0478953214', '02 520 25 25', 'vrai courriel', 'www.siteweb.com', 'RRRRRRRRRRRRRRRRR', 0, 'adresse nulle', '1000', 'Bruxelles', NULL, 'Belgique', 'admin', '0000-00-00', 19, 7),
(41, 'test felicien', '', '', '', '', '', '', 1, '', '', '', NULL, '', 'admin', '0000-00-00', 11, 4),
(42, 'test de magicien', 'r', 'u', 't', 'i', 'o', 'c', 1, 'adresse terrible', 'a', 'z', NULL, 'e', 'admin', '0000-00-00', 11, 7),
(43, 'Feliciena', 'sdf', 'sdf', 'sdf', 'sdf', 'sdf', 'sdf', 1, 'A', 'sd', 'df', NULL, 'sdf', 'admin', '0000-00-00', 11, 5),
(44, 'FFSFSDFSDSDFSDSD', '', '', '', '', '', '', 1, 'DFDF', 'SDSDFSDF', 'SDFSDFSDF', NULL, '', 'admin', '0000-00-00', 11, 7);

-- --------------------------------------------------------

--
-- Structure de la table `tictan_customers_accessories`
--

CREATE TABLE IF NOT EXISTS `tictan_customers_accessories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `tictan_customers_accessories`
--

INSERT INTO `tictan_customers_accessories` (`id`, `serial`, `name`, `comment`, `entities_id`, `customers_id`, `accessorymodels_id`, `accessorytypes_id`, `location`, `ticket_tco`, `date_mod`, `author`, `is_deleted`, `is_dynamic`, `users_id`, `groups_id`) VALUES
...
(7, 'numero de serie accessoire', 'Disque externe COMPTA', 'DDDDDDDDDDDDDDD', 22, 22, 4, 4, 'DDDDDDDDDDDD', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(8, 'serie 12345', 'souris verte et rouge', 'RAS', 22, 22, 1, 1, 'salle compta', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(9, 'serie 12345', 'souris verte et rouge', 'RAS', 22, 22, 1, 1, 'salle compta', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(10, '', '', '', 22, 22, 0, 0, '', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0');

-- --------------------------------------------------------

--
-- Structure de la table `tictan_customers_computers`
--

CREATE TABLE IF NOT EXISTS `tictan_customers_computers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `date_mod` datetime DEFAULT NULL,
  `session_admin_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `session_admin_pwd` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `session_user_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `session_user_pwd` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `teamv_pwd` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `typeconnexion` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `adressrange` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
  `adresseip` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mask` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
  `bridge` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
  `location` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `tictan_customers_computers`
--

INSERT INTO `tictan_customers_computers` (`id`, `pcname`, `serial`, `processor`, `ram`, `customers_id`, `entities_id`, `computermodels_id`, `computertypes_id`, `date_mod`, `session_admin_name`, `session_admin_pwd`, `session_user_name`, `session_user_pwd`, `domain_name`, `teamv_logname`, `teamv_pwd`, `typeconnexion`, `adressrange`, `adresseip`, `mask`, `bridge`, `location`, `is_deleted`, `ticket_tco`, `uuid`, `comment`, `author`, `mod_date`) VALUES
(1, 'pcnameNEW', 'serie 1234', 'processeur NEW', '64Go', 22, 22, 14, 1, '0000-00-00 00:00:00', 'adminbistrateur', 'MOT DE PASSE', 'utilisateur USER', 'mot de passe user', 'DDDDDDDDDDDDDDDDDD', 'logname teamviewer', 'mot de passe teamviewerMDPTWM', 'FIXE', '100-200', '192.168.100.120', 'MASQUE GUERE', 'PASSARELLANOUVEUA', '3eme bureau', 0, '0.0000', NULL, 'Commentairte noirE NEW', 'admin', '0000-00-00'),
(2, 'pc uillaume', 'serie guillaume', 'processeur P5', '32Go', 16, 22, 17, 6, '0000-00-00 00:00:00', 'adminguillaume', 'motdepasseguillaume', 'pas de compte user', 'pas de mot de passe utilisateur', 'domine guillaume', 'team_guillaume', 'motdepassteamviewer', NULL, '', '192.168.100.25', '', '', '3eme bureau', 0, '0.0000', NULL, 'Ceci est un commentaire', 'admin', '0000-00-00'),
(3, '', '', '', '', 16, 22, 17, 6, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00'),
(4, '', '', '', '', 16, 22, 17, 6, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00'),
(5, '', '', '', '', 16, 22, 17, 6, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00'),
(6, 'Test', 'test serie', '', '', 16, 22, 16, 5, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, 'Commentaire Patien 2', 'admin', '0000-00-00'),
(7, 'Test', 'test serie', '', '', 16, 22, 16, 5, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, 'Commentaire Patien 2', 'admin', '0000-00-00'),
(8, 'pcname', 'serial', 'processeur', 'ram', 16, 22, 4, 2, '0000-00-00 00:00:00', 'admin compte', 'lot de passe admin', 'comppteutilisateur', 'mot de passe utilisateur', 'nom domaine', 'teamviewer', 'motdepasseteamviewer', NULL, '', 'adresse ip', '', '', 'lieu', 0, '0.0000', NULL, 'commentaire', 'admin', '0000-00-00'),
(9, 'pc', 'serie', 'P', 'R', 16, 22, 1, 1, '0000-00-00 00:00:00', 'admina', 'passwd', 'utilisateur', 'motdepasse', 'domaine', 'team', 'motdepasse', NULL, '', '', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00'),
(10, '', '', '', '', 16, 22, 1, 1, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00'),
(11, 'Pc name c''est long', 'serie longue', 'P', 'R', 16, 22, 1, 1, '0000-00-00 00:00:00', 'ADMIN', 'MOTDEPASSE', 'UTILSATEUR', 'MOTDEPASSE', 'DOMAINE', 'TEAMVIEWER', 'MOTDEPASSE', NULL, '', '192.168.100.101', '', '', 'LOCALISTAION', 0, '0.0000', NULL, 'COMMENATIRE', 'admin', '0000-00-00'),
(12, '', '', '', '', 16, 22, 3, 3, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00'),
(13, 'PC name inconnu', 'serie maison mer2 client bio ', 'P', 'R', 16, 9, 4, 2, '0000-00-00 00:00:00', 'ADMIN', 'MDP', 'USER', 'MDP', 'DOMAINE', 'TWV', 'MDPTMV', NULL, '', 'ADRESSE IP', '', '', 'LIEU', 0, '0.0000', NULL, 'COMMENTAIRE', 'admin', '0000-00-00'),
(14, '', '', '', '', 11, 9, 1, 1, '0000-00-00 00:00:00', '', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00'),
(15, 'pcme 9 mere2Clientmarche bio', 'pcme 9 mere2Clientmarche bio', '', '', 11, 9, 4, 4, '0000-00-00 00:00:00', 'pcme 9 mere2Clientmarche bio', 'pcme 9 mere2Clientmarche bio', 'pcme 9 mere2Clientmarche bio', 'pcme 9 mere2Clientmarche bio', 'pcme 9 mere2Clientmarche bio', 'pcme 9 mere2Clientmarche bio', 'pcme 9 mere2Clientmarche bio', NULL, '', 'pcme 9 mere2Clientmarche bio', '', '', 'pcme 9 mere2Clientmarche bio', 1, '0.0000', NULL, 'pcme 9 mere2Clientmarche bio', 'admin', '0000-00-00'),
(16, 'PC name pour le client Patien Assistance', 'serie 123456', 'Penitum (R) 3.30 GHZ', '4Go', 22, 11, 14, 2, '0000-00-00 00:00:00', 'administrateur', 'ispat1', 'julie', 'motdepasse julie', NULL, 'teamviewer', 'mot de passe', NULL, '', '', '', '', '1er etage bureau coordi', 0, '0.0000', NULL, 'Commenatire', 'admin', '0000-00-00'),
(17, 'PC name Client 2 entite 1ééé', 'serie 123456', 'Pentium (R) core duo', '4Go', 16, 16, 14, 1, '0000-00-00 00:00:00', 'compte admin azertyéééàèç', 'mot de passe azerty', 'qwerty', 'motdepasseqwerty', '', 'teamv logname', 'team passwd', NULL, '', 'non aleatoire 192.168.100', '', '', '', 0, '0.0000', NULL, '', 'admin', '0000-00-00');
...
INSERT INTO `tictan_customers_contacts` (`id`, `customers_id`, `entities_id`, `is_recursive`, `name`, `firstName`, `phone`, `phone2`, `mobile`, `fax`, `email`, `contacttypes_id`, `comment`, `is_deleted`, `address`, `postcode`, `town`, `state`, `country`, `author`, `date_mod`) VALUES
...
(4, 15, 16, 0, 'contact1 NOUVEAU ', 'Prenom contact entite 1 ANCIEN', '00000000000000', '02 450 52 53', '000 MOBILE', '00 FAX', 'courriel NEW NEW', 2, 'Zone remarque NEW', 0, 'rue', '1000', 'VIDE', 'Bruxelles Capitale', 'BEL', '', '0000-00-00'),
(5, 16, 16, 0, 'contact du client 2', 'prenom du contact du client 2', '02 02 002000', '02 540 50 50', '0485 23 25 25', '02 5645745', 'fnezzi@yahoo.com', 0, '', 0, 'Avenue de Tervuren, 458 A', '1000', 'Bruxelles', 'Bruxelles Capitale', 'Belgique', '', '2015-01-14'),
(7, 16, 16, 0, 'Nom contact', 'Prenom contact', '02523522', '', '', '', '', 0, '', 0, 'Rue de l''adresse', '1020', 'Bruxelles', '', 'Belgique', '', '0000-00-00'),
...
(10, 27, 11, 0, 'COntact serieux', 'Prenom serieux', '041 10 10 10', NULL, '0484522356', '02  4565445454', 'contact@courriel.be', 0, 'CCCCCCCCCCCCCC', 0, 'adresse coordinateur', '1000', 'Bruxelle', NULL, 'Bel', 'felicien', '2015-04-28'),
(11, 12, 10, 0, 'NOM contact CLINET AAA', 'Prenom', '', NULL, '', '', '', 0, '', 0, '', '', '', NULL, '', 'admin', '2015-04-28'),
(12, 12, 10, 0, 'NOM contact CLINET AAA', 'Prenom', '', NULL, '', '', '', 0, '', 0, '', '', '', NULL, NULL, 'admin', '2015-04-28'),
(13, 12, 10, 0, 'dsqddsd', 'sddsdds', 'qsdqsdds', NULL, 'qsdqsdsd', 'qsdqsdd', 'qsdqsdqsd', 1, 'qsdqsdqsd', 0, 'sdqsdqsd', 'qsdqsdsdq', 'qsddqsqsd', NULL, NULL, 'admin', '2015-04-28'),
(14, 12, 10, 0, 'sdsdazdaz', 'azdazdazd', 'qsdqsdqsd', NULL, 'qsdqsdqsd', '', 'qsdqsdqsd', 1, 'cccccccccccccccccccc', 0, 'azdazdazdazd', 'azsdfazdz', 'azazdazd', NULL, NULL, 'admin', '2015-04-28');
...
(6, 'photocopie du couloir', 'numero de serie photocopieur', 6, 4, '192.168.100.100', 'fixe', NULL, '3eme bureau', NULL, 'commentaire photocopieur', '0000-00-00', 'admin', 0, 0, '0', '0', 22, 22),
(7, 'Nom photocopieur', 'Serie photocoepir', 7, 6, '192.168.100.100', 'fixe', NULL, '3eme bureau', NULL, 'Photocopieur COmmenaire', '0000-00-00', 'admin', 0, 0, '0', '0', 22, 22),
(8, 'NOM CORRECT', 'Serie absente', 2, 5, '192.168.100.100', 'fixe', NULL, '3eme bureauX', NULL, 'Photocopieur COmmenaire', '0000-00-00', 'admin', 0, 0, '0', '0', 22, 22),
(9, 'Nom equipement', 'numero de serie photocopieur', 6, 2, '192.168.100.100', 'wifi', NULL, '3eme bureau', NULL, 'CCCC', '0000-00-00', 'admin', 0, 0, '0', '0', 22, 22),
(10, 'Nom equipement', 'numero de serie photocopieur', 6, 2, '', 'dhcp', NULL, '3eme bureau', NULL, 'Cecie est un commentaire', '0000-00-00', 'admin', 0, 0, '0', '0', 22, 22),
(11, 'Nom equipement', 'numero de serie photocopieur', 6, 2, '', 'dhcp', NULL, '3eme bureau', NULL, 'Cecie est un commentaire', '0000-00-00', 'admin', 1, 0, '0', '0', 22, 22);
...
(6, 'Nom equipement imprimante', 'numero de serie imprimante', 5, 5, '192.168.100.100', 'wifi', NULL, '3EME', NULL, 'Commenbaire', '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0', 19, 16),
(7, 'yttyitit', 'serie derturutr', 5, 7, '1232132121', 'wifi', NULL, 'jhghgikhgig', NULL, 'COMMENTAIRE', '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0', 19, 16),
(5, 'IMP-01', '123456789', 5, 9, '', 'DHCP', 'RJ45', '2eme etage bureau 101', NULL, 'test de saisie', '2015-03-24 00:00:00', '', 0, 0, 'Syhan', '', 22, 22),
(8, 'imprimante', 'serie', 4, 5, '192.168.100.102', 'fixe', NULL, 'LOCALISATION NON VIDE', NULL, 'COMMENTAIRE', '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0', 19, 16),
(9, 'sdfsdfsdf', 'sdfsdfsdf', 6, 11, 'dfsdfqsdf', 'dhcp', NULL, 'sdffsdsdf', NULL, 'sdfsdsdfsdf', '0000-00-00 00:00:00', 'admin', 1, 0, '0', '0', 16, 16),
(10, 'sdfsdfsdf', 'sdfsdfsdf', 6, 11, 'dfsdfqsdf', 'dhcp', NULL, 'sdffsdsdf', NULL, 'sdfsdsdfsdf', '0000-00-00 00:00:00', 'admin', 1, 0, '0', '0', 16, 16),
(11, 'sdfsdfsdf', 'sdfsdfsdf', 6, 11, 'dfsdfqsdf', 'dhcp', NULL, 'sdffsdsdf', NULL, 'sdfsdsdfsdf', '0000-00-00 00:00:00', 'admin', 1, 0, '0', '0', 16, 16),
(12, 'imprimante nouvelle', 'serie nopuvelle', 6, 12, '11111111111111111111111', 'wifi', NULL, 'Llllllllllllllllllllllllllllll', NULL, 'ccccccccccccccccc', '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0', 16, 16),
(13, 'IMPRIMENATE SALON', 'SSSSSS', 4, 8, '192.1168.10.10', 'fixe', NULL, '3eme bureau', NULL, 'CCCCCCCCCCC', '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0', 22, 22),
(14, 'imprimnate de salon', 'Serie imprimante', 6, 8, '192.168.100.25', 'dhcp', NULL, '3eme bureau Achille', NULL, 'DDDDDDDDDDDDDDDDDDDDDDDDDDDD', '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0', 22, 22);
...
CREATE TABLE IF NOT EXISTS `tictan_customers_disk` (
  ...
  `entities_id` int(11) NOT NULL DEFAULT '0',
  `date_mod` date DEFAULT NULL,
  `diskmodels_id` int(11) DEFAULT '0',
  `disktypes_id` int(11) DEFAULT '0',
...
--
-- Contenu de la table `tictan_customers_disk`
--

INSERT INTO `tictan_customers_disk` (`id`, `supplier`, `computers_id`, `customers_id`, `entities_id`, `date_mod`, `diskmodels_id`, `disktypes_id`, `partition1`, `partition2`, `partition3`, `is_deleted`, `is_dynamic`, `users_id`, `ticket_tco`, `comment`, `author`, `name`) VALUES
(1, 'Supplier de disque', 1, 22, 22, '2015-04-12', 1, 2, 'Partition 1', 'Partition 2', 'Partition 3', 0, 0, '0', '0.0000', NULL, 'felicien', ''),
(2, 'Supplier de disque', 1, 22, 22, '2015-04-12', 2, 2, 'Partion UNIQUE', NULL, NULL, 0, 0, '0', '0.0000', NULL, 'felicien', '');
...
(5, 'Ecran de test', 'serie numeroe', 22, 22, '3eme bureau Achille', 'CCCCCCCCCCCCCC', '0000-00-00 00:00:00', '', 8, 1, NULL, 0, 0, '', ''),
(6, 'Ecran moniteur', 'qsqsddssdq', 22, 22, 'qsdsdqdsqqsdqsd', 'CCCC', '0000-00-00 00:00:00', 'admin', 8, 2, NULL, 0, 0, '0', '0'),
(7, '', '', 22, 22, '', '', '0000-00-00 00:00:00', 'admin', 0, 0, NULL, 0, 0, '0', '0'),
(8, NULL, 'ssssssssssssss', 22, 22, 'lllllllllllllllll', 'ccccccccccccccccc', '0000-00-00 00:00:00', 'admin', 10, 2, NULL, 1, 0, '', '');
...
(3, 'BBB', 'clavier superpouvoir', NULL, 9, 11, 2, 1, 'cxcxccxxc', NULL, NULL, '', 0, 0, 'Username 1', 'Groupe 1'),
(4, 'sERIE A', 'NAME A', 'COMMENTAIRE A', 16, 16, 1, 1, 'bureau secretaire', NULL, NULL, '', 0, 0, 'username 3', 'Group 4'),
(7, 'numero de serie accessoire', 'Disque externe COMPTA', 'DDDDDDDDDDDDDDD', 16, 22, 5, 2, 'DDDDDDDDDDDD', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(5, 'Numer de serie', 'Nom Accessoire NEW', NULL, 9, 11, 1, 3, 'lieu noir', NULL, NULL, '', 1, 0, 'user rouge', 'groupe noir'),
(6, 'Serie specielae', 'souris blanche', NULL, 9, 10, 1, 1, '2eme bureau', NULL, NULL, '', 0, 0, 'felicien', 'Finance'),
(8, NULL, 'Nom Accessoire', 'RAS Commentaires', 22, 22, 3, 2, '4eme etage', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(9, NULL, 'sqdfqsdfa', 'qsdqsdqSD', 22, 22, 2, 3, 'sqdqsdaq', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(10, NULL, 'Disque externe COMPTA', 'DANS LE BLOC COMMENTAIRE', 22, 22, 4, 4, '1er bureau compta', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(11, NULL, 'Disque externe COMPTA', 'RAS Commentaires', 22, 22, 4, 4, '1er bureau compta', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(12, NULL, 'dddddddddddddddddddddddddd', 'ddddddddddddddddddd', 22, 22, 4, 4, 'dddddddddddddddddddd', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(13, NULL, 'DDDDDDDDDDDDDD', 'DDDDDDDDDDDDD', 22, 22, 4, 4, 'DDDDDDDDDDDDDD', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(14, 'DDDDDDDDDDDDDD', 'DDDDDDDDDDDDDD', 'DDDDDDDDDDDDD', 22, 22, 4, 4, 'DDDDDDDDDDDDDD', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0'),
(15, 'DDDDDDDDDDDDDDD', 'Disque externe COMPTA', 'ddddddddddddddd', 22, 22, 4, 4, 'dddddddddddddd', NULL, '0000-00-00 00:00:00', 'admin', 0, 0, '0', '0');
...
(34, 'dfgdgff', 'fggfdf', 'dffg', 'fgfgfg', 'fg', 'gf', 22, 22, 2, 2, NULL, 1, 3, 0, 'fgd', 'g', 'g', 'g', 'g', 'g', 'g', 'g', NULL, 0, 0, 0, 0, 0, 'g', 'g', '0.0000', NULL, '', '', '0000-00-00');
...
CREATE TABLE IF NOT EXISTS `tictan_customer_network` (
  ...
  `users_id` varchar(30) COLLATE utf8_unicode_ci DEFAULT '0',
  `groups_id` varchar(30) COLLATE utf8_unicode_ci DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `date_mod` (`date_mod`),
  KEY `entities_id` (`customers_id`),
  KEY `customers_id` (`customers_id`),
...
--
-- Contenu de la table `tictan_customer_network`
--

INSERT INTO `tictan_customer_network` (`id`, `serial`, `name`, `comment`, `entities_id`, `customers_id`, `networkmodels_id`, `networktypes_id`, `adresseip`, `bridge`, `mask`, `smtpserver`, `fax`, `login`, `password`, `adressrange`, `typeadressage`, `connexionvia`, `location`, `ticket_tco`, `date_mod`, `author`, `is_deleted`, `is_dynamic`, `users_id`, `groups_id`) VALUES
(1, '', '', '', 22, 0, 8, 4, '', '', '', NULL, '', '', '', '', 'DHCP', '', '', NULL, '0000-00-00', '', 0, 0, '0', '0'),
(2, '', '', 'RAS Commentaires', 22, 0, 10, 5, '192.168.20.36', 'passerelle', '0.0.0.0', NULL, '02 568 65 56 ', 'login', 'password', '195.168.20', 'DHCP', '', '2ele bureau', NULL, '0000-00-00', '', 0, 0, '0', '0'),
(3, '', '', '', 22, 0, 11, 8, '', '', '', NULL, '', '', '', '', 'DHCP', '', '', NULL, '0000-00-00', '', 0, 0, '0', '0'),
(4, '', NULL, NULL, 22, 22, 10, 4, NULL, '', '', NULL, NULL, '', '', '', 'dhcp', NULL, '', NULL, '0000-00-00', 'admin', 0, 0, '0', '0'),
(5, '', NULL, NULL, 22, 22, 6, 5, NULL, '', '', NULL, NULL, '', '', '', 'dhcp', NULL, '', NULL, '0000-00-00', 'admin', 0, 0, '0', '0'),
(6, 'serie reseau', 'Routeur', 'RAS commentaire basique', 16, 22, 8, 4, '192.168.100.100', '192.168.100.0', '0.0.0.0', NULL, '02 520 25 25', 'login new', 'mot de depasse', '100 - 200', 'dhcp', '', '3eme bureau', NULL, '0000-00-00', 'admin', 0, 0, '0', '0'),
(7, 'serie', 'Nom de reseau', 'COMMENTAIRE', 16, 16, 9, 4, '192.168.100.102', 'PASSERELLE', '0.0.0.0', 'SMTP mtpserver', NULL, 'login new', 'mot de passe', '200-300', 'dhcp', NULL, 'LOCALISATION NON VIDE', NULL, '0000-00-00', 'admin', 0, 0, '0', '0'),
(8, 'azeaze', 'azeazeaze', 'zea', 16, 16, 8, 4, 'aze', 'zea', 'zae', NULL, 'eaz', 'aze', 'eza', 'aze', 'dhcp', '', 'aze', NULL, '0000-00-00', 'admin', 0, 0, '0', '0');
...
CREATE TABLE IF NOT EXISTS `tictan_cust_comp_disk` (
  ...
  `diskmodels_id` int(11) DEFAULT NULL,
  `disktypes_id` int(11) DEFAULT NULL,
  `date_mod` datetime DEFAULT NULL,
  `partition1` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `partition2` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `partition3` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_deleted` int(1) NOT NULL DEFAULT '0',
  `comment` text COLLATE utf8_unicode_ci,
  `author` varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'felicien',
  `mod_date` date NOT NULL,
  ...
  KEY `entities_id` (`entities_id`),
  KEY `customers_id` (`customers_id`),
  KEY `computer_id` (`computers_id`),
  KEY `serial` (`serial`),
  KEY `diskmodel_id` (`diskmodels_id`),
  KEY `disktype_id` (`disktypes_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=26 ;

--
-- Contenu de la table `tictan_cust_comp_disk`
--

INSERT INTO `tictan_cust_comp_disk` (`id`, `name`, `serial`, `supplier`, `customers_id`, `entities_id`, `computers_id`, `diskmodels_id`, `disktypes_id`, `date_mod`, `partition1`, `partition2`, `partition3`, `is_deleted`, `comment`, `author`, `mod_date`) VALUES
(1, 'nom du disque 1', '1234seriedisque', 'Suppier disque 1', 22, 22, 1, 6, 6, '2015-04-12 00:00:00', 'partition 1', 'partition 2', 'partition 3', 0, 'Commentaire test', 'felicien', '0000-00-00'),
(2, 'nom du disque 2', '4321seriedisque2', 'Supplier 2', 22, 22, 1, 7, 7, '2015-04-12 00:00:00', 'Partion UNIQUE', NULL, NULL, 0, 'Commentaire disque 2 client 22', 'felicien', '0000-00-00'),
(3, 'Disque 1', 'serie1 Patien assistance Client', 'Fournisseur', 22, 22, NULL, 6, 6, '0000-00-00 00:00:00', NULL, NULL, NULL, 0, 'Commentaire  DISQUE', 'admin', '0000-00-00'),
(4, 'Nom du disque 3', 'serie 123456', 'Forunisseur Bete', 22, 22, NULL, 6, 7, '0000-00-00 00:00:00', 'partition bete 1', 'P2', 'P3', 0, 'commenaire bebe', 'admin', '0000-00-00'),
(5, 'Nom de disque 3', 'serie noire', 'fournisseur', 22, 22, NULL, 7, 7, '0000-00-00 00:00:00', 'partition 1', 'partition 2', '', 1, 'COçmme', 'admin', '0000-00-00'),
(6, 'Nom de disque 5', 'serie 5', '', 22, 22, NULL, 7, 6, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'Commentaire  DISQUE', 'admin', '0000-00-00'),
(7, 'Nom de disque 5', 'serie 5', '', 22, 22, NULL, 7, 6, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'Commentaire  DISQUE', 'admin', '0000-00-00'),
(8, 'Nom de disque 5', 'serie 5', '', 22, 22, NULL, 7, 6, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'Commentaire  DISQUE', 'admin', '0000-00-00'),
(9, 'qd', 'qds', 'qsd', 22, 22, NULL, 6, 6, '0000-00-00 00:00:00', 'ds', 'SDQ', 'SD', 0, 'SDQ', 'admin', '0000-00-00'),
(10, 'qsf', 'qsd', '', 22, 22, NULL, 6, 6, '0000-00-00 00:00:00', 'qsd', 'dqs', 'qsd', 0, 'qsddds', 'admin', '0000-00-00'),
(11, 'qsf', 'qsd', '', 22, 22, 1, 6, 6, '0000-00-00 00:00:00', 'qsd', 'dqs', 'qsd', 0, 'qsddds', 'admin', '0000-00-00'),
(12, 'disque4', 'serie 4', 'F4', 22, 22, NULL, 6, 7, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'Commentaire  DISQUE', 'admin', '0000-00-00'),
(13, 'qsdzdds', 'zadqsd', 'dqsds', 22, 22, NULL, 6, 6, '0000-00-00 00:00:00', 'qsddqsdqs', 'dsqds', 'dsqSDD', 0, 'QSDDS', 'admin', '0000-00-00'),
(14, 'disque 5', 'serie illilmitée', 'forunisseur2', 22, 22, NULL, 6, 6, '0000-00-00 00:00:00', '', '', '', 0, '', 'admin', '0000-00-00'),
(15, 'd', 's', 'Forunisseur Bete', 22, 22, 1, 6, 6, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'Commentaire Patien 2', 'admin', '0000-00-00'),
(16, 'disque 5', 'Serie 5', 'Forunisseur fantome', 22, 22, 1, 7, 6, '0000-00-00 00:00:00', 'Windows', 'UBUNTU', '', 0, 'Commentaire Disque', 'admin', '0000-00-00'),
(17, 'disque Entite 1 Client 2 Entite 1', 'serie123456AJOUTER', '', 16, 16, 17, 0, 0, '0000-00-00 00:00:00', 'P1', 'P2', 'P33333333333333333', 0, 'CCCCCCCCCCCCCC', 'admin', '0000-00-00'),
(18, 'disque Entite 1 Client 2 Entite 1', 'serie1234567', '', 16, 16, 17, 7, 4, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'CCCCCCCCCCCCCC', 'admin', '0000-00-00'),
(19, 'Disque de moi meme', 'GGGGGGGGGGGGGGGG', '', 16, 16, 17, 4, 4, '0000-00-00 00:00:00', 'p', 'pppp', 'pppppp', 0, 'ccccc', 'admin', '0000-00-00'),
(20, 'Disque de moi meme', 'sssss', 'fff', 0, 16, 17, 6, 6, '0000-00-00 00:00:00', 'p', 'pppp', 'pppppp', 0, 'ccccc', 'admin', '0000-00-00'),
(21, 'efzefgze', 'zefzefze', '', 0, 16, 17, 6, 6, '0000-00-00 00:00:00', '', '', '', 0, '', 'admin', '0000-00-00'),
(22, 'Nom du disque 22', 'serie 123456 22', '', 16, 16, 17, 6, 4, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'CCCCCCCCCCCCCCCC', 'admin', '0000-00-00'),
(23, 'Nom du disque 23', 'serie 23', 'Foournisseeur 23', 16, 16, 17, 6, 6, '0000-00-00 00:00:00', 'P1 23', 'P2 23', 'P3 23', 1, 'Commentaire 23', 'admin', '0000-00-00'),
(24, 'Nom du disque 3', 'serie 123456', '', 16, 16, 17, 6, 6, '0000-00-00 00:00:00', '', '', '', 0, '', 'admin', '0000-00-00'),
(25, 'Nom du disque 3', 'serie 12345', 'ffff', 16, 16, 17, 6, 6, '0000-00-00 00:00:00', 'P1', 'P2', 'P3', 0, 'CCCCCCCCCCCCCCCCCC', 'admin', '0000-00-00');

-- --------------------------------------------------------

--
-- Structure de la table `tictan_cust_comp_soft`
--

CREATE TABLE IF NOT EXISTS `tictan_cust_comp_soft` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `licence` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `editor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `entities_id` int(11) NOT NULL DEFAULT '0',
  `date_mod` date DEFAULT NULL,
  `softmodels_id` int(11) NOT NULL DEFAULT '0',
  `softypes_id` int(11) NOT NULL DEFAULT '0',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  `is_dynamic` tinyint(1) NOT NULL DEFAULT '0',
  `users_id` varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `groups_id` varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  ...
  KEY `groups_id` (`groups_id`),
  KEY `users_id` (`users_id`),
  KEY `os_id` (`softmodels_id`),
  KEY `ostype_id` (`softypes_id`),
  KEY `is_deleted` (`is_deleted`),
  KEY `is_dynamic` (`is_dynamic`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=14 ;

--
-- Contenu de la table `tictan_cust_comp_soft`
--

INSERT INTO `tictan_cust_comp_soft` (`id`, `name`, `licence`, `editor`, `supplier`, `computers_id`, `customers_id`, `entities_id`, `date_mod`, `softmodels_id`, `softypes_id`, `is_deleted`, `is_dynamic`, `users_id`, `groups_id`, `ticket_tco`, `uuid`, `start_date`, `end_date`, `comment`, `author`, `mod_date`) VALUES
(7, 'Nom logiciel', 'licenece 1', 'Editeur NEW', 'forunisseur2', 1, 22, 22, '0000-00-00', 8, 2, 0, 0, '0', '0', '0.0000', NULL, '2015-03-03', '2016-03-02', 'Commentaire Patien 2', 'admin', '0000-00-00'),
(8, 'Logiciel 2', 'Pas de licence', 'Non editor', 'No fournisseur', 1, 22, 22, '0000-00-00', 11, 3, 0, 0, '0', '0', '0.0000', NULL, '2014-01-01', '2016-03-02', 'No comment', 'admin', '0000-00-00'),
(9, 'LOG', 'L', 'E', 'F', 1, 22, 22, '0000-00-00', 7, 5, 0, 0, '0', '0', '0.0000', NULL, '2015-03-03', '2016-03-02', 'Commentaire Patien 2', 'admin', '0000-00-00'),
(10, 'd', 'l', 'e', 'f', 1, 22, 22, '0000-00-00', 5, 5, 0, 0, '0', '0', '0.0000', NULL, '2014-01-01', '2016-03-02', 'Commentaire Patien 2', 'admin', '0000-00-00'),
(11, '', '', '', '', 1, 22, 22, '0000-00-00', 0, 0, 0, 0, '0', '0', '0.0000', NULL, '0000-00-00', '0000-00-00', '', 'admin', '0000-00-00'),
(12, 'ertgergerg', 'ezetgezr', 'tgertgerter', 'tgertgertge', 17, 16, 16, '0000-00-00', 5, 1, 1, 0, '0', '0', '0.0000', NULL, '0000-00-00', '0000-00-00', 'zertgzertgzertg', 'admin', '0000-00-00'),
(13, 'Logiciel 1', 'Licenece 4 CCCCRRRR', 'Editeur 5', 'Fournisseur XXXXXXXXXXXXX', 17, 16, 16, '0000-00-00', 12, 3, 0, 0, '0', '0', '0.0000', NULL, '2014-01-01', '2016-03-02', 'Commentaire Patien 2', 'admin', '0000-00-00');

-- --------------------------------------------------------

--
-- Structure de la table `tictan_cust_comp_virdrive`
--

CREATE TABLE IF NOT EXISTS `tictan_cust_comp_virdrive` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `drivename` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `password` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `computers_id` int(11) NOT NULL DEFAULT '0',
  `customers_id` int(11) NOT NULL DEFAULT '0',
  `entities_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `tictan_cust_comp_virdrive`
--

INSERT INTO `tictan_cust_comp_virdrive` (`id`, `drivename`, `password`, `computers_id`, `customers_id`, `entities_id`, `is_deleted`, `comment`, `author`, `date_mod`) VALUES
(1, 'QSDQSD', NULL, 1, 22, 22, 0, 'QSDQSDQS', 'admin', '0000-00-00'),
(2, 'disque virtuel 3', NULL, 1, 22, 22, 0, 'Commentaire disque virtuel', 'admin', '0000-00-00'),
(3, '', NULL, 1, 22, 22, 0, '', 'admin', '0000-00-00'),
(4, '', NULL, 1, 22, 22, 0, '', 'admin', '0000-00-00'),
(5, 'f:\\\\hermes\\Doc_generalDDDDDDDDDDDDDD', 'DDDDDDDDDDDDDDDDD', 17, 16, 16, 1, 'DDDDDDDDDDDDDDDDDDFFFFFFFFFFFFFF', '', '0000-00-00'),
(6, 'f:\\\\hermes\\Doc_geneFFFFFFFFFFFFFFF', 'FFFFFFFFFFFFFFFFFFFFFF', 17, 16, 16, 0, 'CCCCCCCCFFFFFFFFFFFFFFFFFFFFFFFFFF', '', '0000-00-00');
...
--
-- Structure de la table `tictan_diskmodels`
--

CREATE TABLE IF NOT EXISTS `tictan_diskmodels` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_deleted` int(11) NOT NULL DEFAULT '0',
  `comment` text COLLATE utf8_unicode_ci,
...
--
-- Contenu de la table `tictan_diskmodels`
--

INSERT INTO `tictan_diskmodels` (`id`, `name`, `is_deleted`, `comment`, `author`, `mod_date`) VALUES
(6, 'disque dur Winchester 360 Go', 0, NULL, '', '0000-00-00'),
(7, 'disque WHOLME SATA 1 Tera', 0, NULL, '', '0000-00-00');

-- --------------------------------------------------------

--
-- Structure de la table `tictan_disktypes`
--

CREATE TABLE IF NOT EXISTS `tictan_disktypes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_deleted` int(11) NOT NULL DEFAULT '0',
  `comment` text COLLATE utf8_unicode_ci,
...
--
-- Contenu de la table `tictan_disktypes`
--

INSERT INTO `tictan_disktypes` (`id`, `name`, `is_deleted`, `comment`, `author`, `mod_date`) VALUES
(6, 'disque dur type e-fire', 0, 'test commentaire', '', '0000-00-00'),
(7, 'Type Sata', 0, NULL, '', '0000-00-00');
...
INSERT INTO `tictan_entities` (`id`, `companyname`, `vatcode`, `account1`, `account2`, `customtype`, `phone`, `phone2`, `mobile`, `fax`, `email`, `website`, `comment`, `address`, `postcode`, `town`, `state`, `country`, `is_deleted`, `author`, `date_mod`) VALUES
...
(10, '10 ASBL TIC TANNE 10', 'vate  13213154654546', 'BE-123456789', 'BE-9876543210', 1, '01 585477777', '02 88888888', '0485 23 25 25', '02  4565445454', 'fnezzi@yahoo.com', 'www.amandine.com', 'je suis un peu fatiguÃ© d''ecrire. la vies et un lon fleuve tranquile', 'Rue du CPAS, 56  ', '1000', 'Bruxelles', 'Brux-Capitale', 'BEL', 1, 'NEZZI', NULL),
...
(14, 'AAAA', 'BBBB', '1212123', '113121', 1, '32121231', '13132123', '231321321', '21321321', 'fnezzi@gmail.com', '21321231', 'ZZZZZZZZZZZZZ', '232121321', '321321321', '1321321321', '1231321', 'BEL', 1, 'NEZZI', '0000-00-00'),
(15, 'TEST RAISON SOCIALE', 'vatcodeamlkjakja', 'compte 12222', 'compte 122333', 1, '00000000', '22222222', '0000000', '00000000', 'fnezzi@gmail.com', 'www.ggg.com', 'rrrrrrrtttttttttttttttttttoouyiugkk', 'Rue des eglise, 46', '1050', 'Bruxelles', 'Bruxelles Capitale', 'Belgique', 1, 'felicien', '0000-00-00'),
(16, 'Entite 1', '123456', '01234565', '0123456', 1, '01245678', '0456123', '0485021021023', '02 562222', 'fnezzi@gmail.com', 'wwww.bbbb.com', 'Zone remarque pour Entite 1', 'Rue entite 1', '1000', 'Bruxelles', 'Bruxelles Capitale', 'Belgique', 1, 'felicien', '0000-00-00'),
...
(24, 'ISPAT', 'code tva ispat', 'compte ISPAT', 'compte ISPAT', 0, '+3222197478', NULL, '+32 474 52 35 61', '+322 218 38 68', 'info@ispat.be', 'www.ispat.be', 'ASBL Aplphabetisation ', NULL, '1210', 'Bruxelles', NULL, 'Belgique', 1, 'admin', NULL),
(25, 'ezzerzer', 'zerzerzer', 'zerzerzer', 'zerezzerre', 0, 'Telephone', NULL, 'GSM TEL', 'FAX', 'courriel@gmail.com', 'www.ooo.be', 'CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC', NULL, 'CCCCCCCCCCCCC', 'LLLLLLLLLLLLLL', NULL, 'PPPPPPPPPPPPPPPP', 1, 'admin', NULL),
(26, 'nom ou raison sociale', 'Code tva 2121', '', '', 0, '', NULL, '', '', '', '', '', '', '', '', NULL, '', 1, 'admin', NULL),
(27, 'Asbl NEW', '123456789', 'BE1231321321', 'BE55555555', 0, '041 23 56 56 ', NULL, '04575 57 57', '041 55 23 63', 'aaa@gmail.com', 'www.ooo.be', 'CCCCCCCCCCCCDDDDDDDDDDDDDDDDDDDD', 'Rue des RUE RUE', '4000', 'Liege Guillemins', NULL, 'Belgique', 0, 'admin', NULL),
(28, 'Bidon', '', '', '', 0, '', NULL, '', '', '', '', '', '', '', '', NULL, '', 1, 'admin', NULL),
(29, 'bidon', '', '', '', 0, '', NULL, '', '', '', '', '', '', '', '', NULL, '', 1, 'admin', NULL),
(30, 'bidon 2222', '', '', '', 0, '', NULL, '', '', '', '', '', '', '', '', NULL, '', 1, 'admin', NULL),
(32, 'ENTITE DU 09052015 YYYY', 'TVA ENTITE DU 09052015', 'COMPTE 1 ENTITE DU 09052015', 'COMPTE 2 ENTITE DU 09052015', 0, '02 45 45 45 ENTITE DU 09052015', NULL, 'GSM ENTITE DU 09052015', 'FAXENTITE DU 09052015', 'COURRIEL ENTITE DU 09052015', 'SITE WEB ENTITE DU 09052015', 'COMMENTAIRE ENTITE DU 09052015', 'ADRESSE ENTITE DU 09052015', '1000', 'BURXELLES ENTITE DU 09052015', NULL, 'BEL ENTITE DU 09052015', 0, 'admin', '0000-00-00'),
(31, 'BIDON 4444', '', '', '', 0, '', NULL, '', '', '', '', '', '', '', '', NULL, '', 0, 'admin', NULL);
...
(11, 'Moniteur Modeles moi meme', 'enlve moi cela', '0000-00-00 00:00:00', 'admin', 0, 0),
(12, 'azazddz', 'azda', '0000-00-00 00:00:00', 'admin', 0, 0),
(13, 'rtehrthrth', 'rthrethrtherth', '0000-00-00 00:00:00', 'admin', 0, 0);
...
(6, 'LED', NULL, NULL, '', 0, 0),
(7, 'CRT', NULL, NULL, '', 0, 0),
(8, 'typr', 'sdfsdfsqdfsd', '0000-00-00 00:00:00', 'admin', 1, 0),
(9, 'ajout type moniteur', 'Type moniteur', '0000-00-00 00:00:00', 'admin', 0, 0);
...
(14, 'Reseau', 'COmmenatire', '0000-00-00', 'admin', 0);
...
(11, 'Equipement reseau', '', '0000-00-00', 'admin', 0),
(12, 'reseau bidon', 'comment bidon', '0000-00-00', 'admin', 1);
...
(5, 'Modele new moi meme', 'CCCCCCCCCCCCCCCCCCCCCCCC', '0000-00-00', 'admin', 0),
(6, 'AJMI', 'CCCCCCCCCCCCCCCCCCCCCC', '0000-00-00', 'admin', 0),
(7, 'dfdfgdgdgds', 'ddddddddddddddddddddddd', '0000-00-00', 'admin', 0),
(8, 'dfqsdsqdfsd', 'fsqfqsfqsdfsd', '0000-00-00', 'admin', 0),
(9, 'Model moi imprimante', 'CCCCCCCCCCCCC', '0000-00-00', 'admin', 0);
...
INSERT INTO `tictan_skills` (`id`, `name`, `comment`, `is_deleted`, `author`, `date_mod`) VALUES
...
(6, 'Nouvelle competence  developpeur', 'Commentaire dREMOVED', 1, 'admin', '0000-00-00'),
(7, 'Nouvelle competence  developpeur', 'COmmentaire developpeur', 0, 'admin', '0000-00-00'),
(8, 'Voleur de pomme', 'Commentaire de pommeS', 1, 'admin', '0000-00-00'),
(9, 'Joueuse de ludo', 'Khady qui ne sait pas jouer 6', 1, 'admin', '0000-00-00');

-- --------------------------------------------------------

--
-- Structure de la table `tictan_softmodels`
--

CREATE TABLE IF NOT EXISTS `tictan_softmodels` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comment` text COLLATE utf8_unicode_ci,
  `date_mod` date NOT NULL,
...
--
-- Contenu de la table `tictan_softmodels`
--

INSERT INTO `tictan_softmodels` (`id`, `name`, `comment`, `date_mod`, `author`, `is_deleted`) VALUES
...
INSERT INTO `tictan_softwaremodels` (`id`, `name`, `comment`, `date_mod`, `author`, `is_deleted`) VALUES
(6, 'Sweet home 3D', 'CAO/DAO libre', '2015-02-17', 'felicien', 0),
(5, 'Autocad', 'CAO/DAO', '2015-02-17', '', 0),
(7, 'Acrobat Reader', NULL, '2015-02-17', 'felicien', 0),
(8, 'Office 2007', NULL, '2015-02-17', '', 0),
...
(13, 'Business Object SAP', NULL, '2015-02-17', 'felicien', 0),
(14, 'SQL Server 20112', NULL, '2015-02-17', 'felicien', 0),
(15, 'lllllllllllllllllllllllllllll', 'ccccccccccccccc', '0000-00-00', 'admin', 0),
(16, 'Logiciel new', 'Commentaire nouveau', '0000-00-00', 'admin', 0);
...
INSERT INTO `tictan_softwaretypes` (`id`, `name`, `comment`, `date_mod`, `author`, `is_deleted`) VALUES
...
(9, 'Famille logicielleq', 'CCCCCCCCCCCCCCCCCCCCCC', '0000-00-00', 'admin', 0),
(10, 'AFLLLLLLLLLL', 'CLLLLLLLLLLLLLL', '0000-00-00', 'admin', 1),
(11, 'AFMMMM', 'CMMMM', '0000-00-00', 'admin', 1);

-- --------------------------------------------------------

--
-- Structure de la table `tictan_softypes`
--

CREATE TABLE IF NOT EXISTS `tictan_softypes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comment` text COLLATE utf8_unicode_ci,
  `date_mod` date NOT NULL,
...
--
-- Contenu de la table `tictan_softypes`
--

INSERT INTO `tictan_softypes` (`id`, `name`, `comment`, `date_mod`, `author`, `is_deleted`) VALUES
(1, 'systeme d''exploitation', NULL, '0000-00-00', '', 0),
(2, 'suite office', NULL, '0000-00-00', '', 0),
(3, 'gestion', NULL, '0000-00-00', '', 0),
(4, 'gestion graphique', NULL, '0000-00-00', '', 0),
...
CREATE TABLE IF NOT EXISTS `tictan_tecskills` (
  ...
  UNIQUE KEY `staff_id` (`staff_id`,`skill_id`),
...
INSERT INTO `tictan_tecskills` (`id`, `staff_id`, `skill_id`, `comment`, `is_deleted`, `author`, `date_mod`) VALUES
(1, 5, 3, 'Gisele', 0, 'felicien', NULL),
(3, 3, 2, 'Guillaue Amey', 0, 'felicien', '2015-03-03'),
(4, 5, 5, 'Gisele', 0, 'felicien', '2015-03-03'),
(5, 7, 7, 'ccccc', 0, 'felicien', NULL);
...
(1, 'Tisserand ', 'Amandine ', '+32473835608', 'amandine.t@attasbl.be', '', 0, 'Rue de Savoie 70 ', '7110', 'Strépy-Bracquegnies ', 'Bruxelles Capitale', 'Belgique', '', '2015-05-13'),
(2, 'CHU', 'Thuan', '+32495576535', 'ck@thuan.onmicrosoft.com', '', 0, 'Evere', '1050', 'Evere', 'Bruxelles Capitale', 'Belgique', 'felicien', '2015-03-24'),
(3, 'AMEY', 'Amouzou Ayawo', '+32483024212', 'amey.a@attasbl.be', '', 0, ' Rue Adolphe Lavalllée 66 ', '1080', 'Molenbeek', 'Bruxelles capitale', 'Belgique', 'felicien', '2015-03-03'),
(4, 'BUJOR', 'Alexandru', '0480 52 52 52 ', 'bujor.a@attasbl.be', '', 0, 'Molenbeek', '1080', 'Molenbeek', 'Bruxelles capitale', 'Pays', 'felicien', '2015-03-03'),
(5, 'Mbangula', 'Gisèle', '0452 52 52 52', 'gisele.m@attasbl.be', '', 0, 'Braine l''Alleud', '5500', 'Braine-L''alleud', 'Brabant', 'Belgique', 'felicien', '2015-02-21'),
...
(7, 'NEZZI', 'Felicien', '+32484522669', 'felicien.n@attasbl.be', '', 0, 'Quai du batelage, 5', 'Bruxelles', '1000', 'Bruxelles capitale', 'Belgique', 'felicien', '2015-05-13');
...
INSERT INTO `tictan_users` (`id`, `userid`, `password`, `profil`, `staff_id`, `comment`, `is_deleted`, `author`, `date_mod`) VALUES
...
(12, 'nezzi', 'nezzi', 'D', 7, 'Commenataire', 0, 'admin', '0000-00-00'),
(13, 'userwebtic', '', 'D', 7, 'CCCCCCCCCCCCCCCCCCC', 1, 'admin', NULL),
(14, 'alex le beau', 'gosse', 'C', 4, 'Test commentaire', 0, 'admin', '0000-00-00');
...
,`ram` varchar(25)
,`adressrange` varchar(25)
,`mask` varchar(25)
,`bridge` varchar(25)
,`serial` varchar(50)
,`computermodels_id` int(11)
,`computertypes_id` int(11)
,`domain_name` varchar(255)
,`session_admin_name` varchar(255)
,`session_admin_pwd` varchar(255)
,`session_user_name` varchar(255)
,`session_user_pwd` varchar(255)
,`teamv_logname` varchar(255)
,`teamv_pwd` varchar(255)
,`adresseip` varchar(255)
,`typeconnexion` varchar(255)
,`comment` text
,`location` varchar(255)
,`author` varchar(30)
,`date_mod` datetime
...
--
-- Doublure de structure pour la vue `vtictan_cust_comp_disk`
--
CREATE TABLE IF NOT EXISTS `vtictan_cust_comp_disk` (
`id` int(11)
,`name` varchar(50)
,`is_deleted` int(1)
,`supplier` varchar(50)
...
,`computers_id` int(11)
,`comment` text
,`diskmodels_id` int(11)
,`disktypes_id` int(11)
,`date_mod` datetime
,`partition1` varchar(20)
,`partition2` varchar(20)
,`partition3` varchar(20)
,`author` varchar(30)
,`pcname` varchar(50)
,`customer_name` varchar(255)
,`mobile_cust` varchar(255)
...
--
-- Doublure de structure pour la vue `vtictan_cust_comp_virtuels`
--
CREATE TABLE IF NOT EXISTS `vtictan_cust_comp_virtuels` (
`id` int(11)
...
--
-- Structure de la table `vtictan_skilltech`
--
-- utilisé(#1356 - View 'tictan.vtictan_skilltech' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
-- Erreur de lecture des données :  (#1356 - View 'tictan.vtictan_skilltech' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)

-- --------------------------------------------------------

--
-- Doublure de structure pour la vue `vtictan_skillteche`
--
CREATE TABLE IF NOT EXISTS `vtictan_skillteche` (
`id` int(11)
,`staff_id` int(11)
,`comment` text
,`is_deleted` tinyint(1)
...
--
-- Doublure de structure pour la vue `vtictan_tecskillse`
--
CREATE TABLE IF NOT EXISTS `vtictan_tecskillse` (
`id` int(11)
,`staff_id` int(11)
,`skill_id` int(11)
,`comment` text
...
--
-- Doublure de structure pour la vue `vtictan_users`
--
CREATE TABLE IF NOT EXISTS `vtictan_users` (
`id` int(11)
,`userid` varchar(255)
,`password` varchar(255)
,`profil` char(1)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_customers` AS select `a`.`id` AS `customers_id`,`a`.`customer_name` AS `customer_name`,`a`.`entities_id` AS `entities_id`,`a`.`phone` AS `phone`,`a`.`mobile` AS `mobile`,`a`.`fax` AS `fax`,`a`.`email` AS `email`,`a`.`website` AS `website`,`a`.`comment` AS `comment`,`a`.`is_deleted` AS `is_deleted`,`a`.`address` AS `address`,`a`.`postcode` AS `postcode`,`a`.`town` AS `town`,`a`.`country` AS `country`,`a`.`date_mod` AS `date_mod`,`a`.`author` AS `author`,`b`.`companyname` AS `companyname`,`c`.`name` AS `customtype_name` from ((`tictan_customers` `a` join `tictan_entities` `b`) join `tictan_customtype` `c`) where ((`a`.`entities_id` = `b`.`id`) and (`a`.`customtype_id` = `c`.`id`));
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_customers_accessories` AS select `a`.`id` AS `id`,`a`.`customers_id` AS `customers_id`,`a`.`entities_id` AS `entities_id`,`a`.`name` AS `name`,`a`.`serial` AS `serial`,`a`.`accessorymodels_id` AS `accessorymodels_id`,`a`.`accessorytypes_id` AS `accessorytypes_id`,`a`.`date_mod` AS `date_mod`,`a`.`comment` AS `comment`,`a`.`location` AS `location`,`a`.`author` AS `author`,`a`.`is_deleted` AS `is_deleted`,`b`.`name` AS `namemodel`,`b`.`is_deleted` AS `is_deleted_model`,`c`.`name` AS `nametype`,`c`.`is_deleted` AS `is_deleted_type`,`e`.`companyname` AS `companynament`,`e`.`mobile` AS `mobile_ent`,`e`.`phone` AS `phone_ent`,`e`.`email` AS `email_ent`,`f`.`customer_name` AS `customer_name`,`f`.`mobile` AS `mobile_cust`,`f`.`phone` AS `phone_cust`,`f`.`email` AS `email_cust` from ((((`tictan_customers_accessories` `a` join `tictan_accessoriesmodels` `b`) join `tictan_accessoriestypes` `c`) join `tictan_entities` `e`) join `tictan_customers` `f`) where ((`a`.`accessorymodels_id` = `b`.`id`) and (`a`.`accessorytypes_id` = `c`.`id`) and (`a`.`entities_id` = `e`.`id`) and (`a`.`customers_id` = `f`.`id`));
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_customers_computers` AS select `a`.`id` AS `id`,`a`.`customers_id` AS `customers_id`,`a`.`entities_id` AS `entities_id`,`a`.`pcname` AS `pcname`,`a`.`processor` AS `processor`,`a`.`ram` AS `ram`,`a`.`adressrange` AS `adressrange`,`a`.`mask` AS `mask`,`a`.`bridge` AS `bridge`,`a`.`serial` AS `serial`,`a`.`computermodels_id` AS `computermodels_id`,`a`.`computertypes_id` AS `computertypes_id`,`a`.`domain_name` AS `domain_name`,`a`.`session_admin_name` AS `session_admin_name`,`a`.`session_admin_pwd` AS `session_admin_pwd`,`a`.`session_user_name` AS `session_user_name`,`a`.`session_user_pwd` AS `session_user_pwd`,`a`.`teamv_logname` AS `teamv_logname`,`a`.`teamv_pwd` AS `teamv_pwd`,`a`.`adresseip` AS `adresseip`,`a`.`typeconnexion` AS `typeconnexion`,`a`.`comment` AS `comment`,`a`.`location` AS `location`,`a`.`author` AS `author`,`a`.`date_mod` AS `date_mod`,`a`.`is_deleted` AS `is_deleted`,`b`.`name` AS `namemodel`,`e`.`companyname` AS `companyname`,`e`.`mobile` AS `mobile_ent`,`e`.`phone` AS `phone_ent`,`e`.`email` AS `email_ent`,`f`.`customer_name` AS `customer_name`,`f`.`mobile` AS `mobile_cust`,`f`.`phone` AS `phone_cust`,`f`.`email` AS `email_cust`,`g`.`name` AS `nametype`,`g`.`is_deleted` AS `is_deletedtype` from ((((`tictan_customers_computers` `a` join `tictan_computermodels` `b`) join `tictan_entities` `e`) join `tictan_customers` `f`) join `tictan_computertypes` `g`) where ((`a`.`computermodels_id` = `b`.`id`) and (`a`.`computertypes_id` = `g`.`id`) and (`a`.`entities_id` = `e`.`id`) and (`a`.`customers_id` = `f`.`id`));
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_customers_contacts` AS select `a`.`id` AS `id`,`a`.`customers_id` AS `customers_id`,`a`.`entities_id` AS `entities_id`,`a`.`name` AS `name`,`a`.`firstName` AS `firstName`,`a`.`phone` AS `phone`,`a`.`mobile` AS `mobile`,`a`.`fax` AS `fax`,`a`.`email` AS `email`,`a`.`contacttypes_id` AS `contacttypes_id`,`a`.`comment` AS `comment`,`a`.`is_deleted` AS `is_deleted`,`a`.`address` AS `address`,`a`.`postcode` AS `postcode`,`a`.`town` AS `town`,`a`.`author` AS `author`,`a`.`date_mod` AS `date_mod`,`b`.`customer_name` AS `customer_name`,`c`.`companyname` AS `companyname`,`d`.`name` AS `contactypename` from (((`tictan_customers_contacts` `a` join `tictan_customers` `b`) join `tictan_entities` `c`) join `tictan_contacttypes` `d`) where ((`a`.`customers_id` = `b`.`id`) and (`a`.`entities_id` = `c`.`id`) and (`a`.`contacttypes_id` = `d`.`id`));
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_customers_monitors` AS select `a`.`id` AS `id_monitor`,`a`.`name` AS `namemonitor`,`a`.`serial` AS `serial`,`a`.`customers_id` AS `customers_id`,`a`.`entities_id` AS `entities_id`,`a`.`comment` AS `comment`,`a`.`date_mod` AS `date_mod`,`a`.`monitormodels_id` AS `monitormodels_id`,`a`.`author` AS `author`,`a`.`monitortypes_id` AS `monitortypes_id`,`a`.`is_deleted` AS `is_deleted`,`a`.`location` AS `location`,`a`.`is_dynamic` AS `is_dynamic`,`a`.`users_id` AS `users_id`,`a`.`groups_id` AS `groups_id`,`b`.`name` AS `namemodel`,`b`.`is_deleted` AS `is_deleted_model`,`c`.`name` AS `nametype`,`c`.`is_deleted` AS `is_deleted_type`,`e`.`companyname` AS `companynament`,`e`.`mobile` AS `mobile_ent`,`e`.`phone` AS `phone_ent`,`e`.`email` AS `email_ent`,`f`.`customer_name` AS `customer_name`,`f`.`mobile` AS `mobile_cust`,`f`.`phone` AS `phone_cust`,`f`.`email` AS `email_cust` from ((((`tictan_customers_monitor` `a` join `tictan_monitormodels` `b`) join `tictan_monitortypes` `c`) join `tictan_entities` `e`) join `tictan_customers` `f`) where ((`a`.`monitormodels_id` = `b`.`id`) and (`a`.`monitortypes_id` = `c`.`id`) and (`a`.`entities_id` = `e`.`id`) and (`a`.`customers_id` = `f`.`id`));
...
--
-- Structure de la vue `vtictan_cust_comp_disk`
--
DROP TABLE IF EXISTS `vtictan_cust_comp_disk`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_cust_comp_disk` AS select `a`.`id` AS `id`,`a`.`name` AS `name`,`a`.`is_deleted` AS `is_deleted`,`a`.`supplier` AS `supplier`,`a`.`customers_id` AS `customers_id`,`a`.`entities_id` AS `entities_id`,`a`.`serial` AS `serial`,`a`.`computers_id` AS `computers_id`,`a`.`comment` AS `comment`,`a`.`diskmodels_id` AS `diskmodels_id`,`a`.`disktypes_id` AS `disktypes_id`,`a`.`date_mod` AS `date_mod`,`a`.`partition1` AS `partition1`,`a`.`partition2` AS `partition2`,`a`.`partition3` AS `partition3`,`a`.`author` AS `author`,`b`.`pcname` AS `pcname`,`f`.`customer_name` AS `customer_name`,`f`.`mobile` AS `mobile_cust`,`f`.`phone` AS `phone_cust`,`f`.`email` AS `email_cust`,`c`.`name` AS `namemodel`,`b`.`is_deleted` AS `is_deleted_model`,`d`.`name` AS `nametype`,`c`.`is_deleted` AS `is_deleted_type`,`e`.`companyname` AS `companyname`,`e`.`mobile` AS `mobile_ent`,`e`.`phone` AS `phone_ent`,`e`.`email` AS `email_ent` from (((((`tictan_cust_comp_disk` `a` join `tictan_customers_computers` `b`) join `tictan_diskmodels` `c`) join `tictan_disktypes` `d`) join `tictan_entities` `e`) join `tictan_customers` `f`) where ((`a`.`diskmodels_id` = `c`.`id`) and (`a`.`disktypes_id` = `d`.`id`) and (`a`.`entities_id` = `e`.`id`) and (`a`.`customers_id` = `f`.`id`) and (`a`.`computers_id` = `b`.`id`));
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_cust_comp_soft` AS select `a`.`id` AS `id`,`a`.`name` AS `name`,`a`.`is_deleted` AS `is_deleted`,`a`.`supplier` AS `supplier`,`a`.`licence` AS `licence`,`a`.`editor` AS `editor`,`a`.`customers_id` AS `customers_id`,`a`.`entities_id` AS `entities_id`,`a`.`computers_id` AS `computers_id`,`a`.`comment` AS `comment`,`a`.`softmodels_id` AS `softmodels_id`,`a`.`softypes_id` AS `softypes_id`,`a`.`date_mod` AS `date_mod`,`a`.`start_date` AS `start_date`,`a`.`end_date` AS `end_date`,`a`.`author` AS `author`,`b`.`pcname` AS `pcname`,`f`.`customer_name` AS `customer_name`,`f`.`mobile` AS `mobile_cust`,`f`.`phone` AS `phone_cust`,`f`.`email` AS `email_cust`,`c`.`name` AS `namemodel`,`b`.`is_deleted` AS `is_deleted_model`,`d`.`name` AS `nametype`,`c`.`is_deleted` AS `is_deleted_type`,`e`.`companyname` AS `companyname`,`e`.`mobile` AS `mobile_ent`,`e`.`phone` AS `phone_ent`,`e`.`email` AS `email_ent` from (((((`tictan_cust_comp_soft` `a` join `tictan_customers_computers` `b`) join `tictan_softwaremodels` `c`) join `tictan_softwaretypes` `d`) join `tictan_entities` `e`) join `tictan_customers` `f`) where ((`a`.`softmodels_id` = `c`.`id`) and (`a`.`softypes_id` = `d`.`id`) and (`a`.`entities_id` = `e`.`id`) and (`a`.`customers_id` = `f`.`id`) and (`a`.`computers_id` = `b`.`id`));

-- --------------------------------------------------------

--
-- Structure de la vue `vtictan_cust_comp_virtuels`
--
DROP TABLE IF EXISTS `vtictan_cust_comp_virtuels`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_cust_comp_virtuels` AS select `a`.`id` AS `id`,`a`.`drivename` AS `drivename`,`a`.`is_deleted` AS `is_deleted`,`a`.`customers_id` AS `customers_id`,`a`.`entities_id` AS `entities_id`,`a`.`password` AS `password`,`a`.`computers_id` AS `computers_id`,`a`.`comment` AS `comment`,`a`.`date_mod` AS `date_mod`,`a`.`author` AS `author`,`b`.`pcname` AS `pcname`,`f`.`customer_name` AS `customer_name`,`f`.`mobile` AS `mobile_cust`,`f`.`phone` AS `phone_cust`,`f`.`email` AS `email_cust`,`e`.`companyname` AS `companyname`,`e`.`mobile` AS `mobile_ent`,`e`.`phone` AS `phone_ent`,`e`.`email` AS `email_ent` from (((`tictan_cust_comp_virdrive` `a` join `tictan_customers_computers` `b`) join `tictan_entities` `e`) join `tictan_customers` `f`) where ((`a`.`entities_id` = `e`.`id`) and (`a`.`customers_id` = `f`.`id`) and (`a`.`computers_id` = `b`.`id`));
...
--
-- Structure de la vue `vtictan_skillteche`
--
DROP TABLE IF EXISTS `vtictan_skillteche`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_skillteche` AS select `a`.`id` AS `id`,`a`.`staff_id` AS `staff_id`,`a`.`comment` AS `comment`,`a`.`is_deleted` AS `is_deleted`,`a`.`author` AS `author`,`a`.`date_mod` AS `date_mod`,`b`.`name` AS `nametech`,`b`.`mobile` AS `mobile`,`b`.`email` AS `email`,`b`.`address` AS `address`,`b`.`postcode` AS `postcode`,`b`.`town` AS `town`,`b`.`state` AS `state`,`b`.`country` AS `country`,`c`.`name` AS `name` from ((`tictan_tecskills` `a` join `tictan_tecstaff` `b`) join `tictan_skills` `c`) where ((`a`.`staff_id` = `b`.`id`) and (`a`.`skill_id` = `c`.`id`));
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_tecskills` AS select `a`.`id` AS `id`,`a`.`staff_id` AS `staff_id`,`a`.`skill_id` AS `skill_id`,`a`.`comment` AS `comment`,`a`.`author` AS `author`,`a`.`date_mod` AS `date_mod`,`a`.`is_deleted` AS `is_deleted`,`b`.`name` AS `name`,`c`.`name` AS `name_tech` from ((`tictan_tecskills` `a` join `tictan_skills` `b`) join `tictan_tecstaff` `c`) where ((`a`.`skill_id` = `b`.`id`) and (`a`.`staff_id` = `c`.`id`));

-- --------------------------------------------------------

--
-- Structure de la vue `vtictan_tecskillse`
--
DROP TABLE IF EXISTS `vtictan_tecskillse`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_tecskillse` AS select `a`.`id` AS `id`,`a`.`staff_id` AS `staff_id`,`a`.`skill_id` AS `skill_id`,`a`.`comment` AS `comment`,`a`.`author` AS `author`,`a`.`date_mod` AS `date_mod`,`a`.`is_deleted` AS `is_deleted`,`b`.`name` AS `name`,`c`.`name` AS `name_tech` from ((`tictan_tecskills` `a` join `tictan_skills` `b`) join `tictan_tecstaff` `c`) where ((`a`.`skill_id` = `b`.`id`) and (`a`.`staff_id` = `c`.`id`));

-- --------------------------------------------------------

--
-- Structure de la vue `vtictan_users`
--
DROP TABLE IF EXISTS `vtictan_users`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vtictan_users` AS select `a`.`id` AS `id`,`a`.`userid` AS `userid`,`a`.`password` AS `password`,`a`.`profil` AS `profil`,`a`.`staff_id` AS `staff_id`,`a`.`comment` AS `comment`,`a`.`is_deleted` AS `is_deleted`,`a`.`date_mod` AS `date_mod`,`a`.`author` AS `author`,`b`.`description` AS `description`,`c`.`name` AS `name`,`c`.`firstName` AS `firstName`,`c`.`mobile` AS `mobile`,`c`.`email` AS `email` from ((`tictan_users` `a` join `tictan_profil` `b`) join `tictan_tecstaff` `c`) where ((`a`.`profil` = `b`.`profil`) and (`a`.`staff_id` = `c`.`id`));
