...
<form class="form-actions" method="post" name="create_cust_comp_disks" action="creat_cust_comp_disks.php" method="post" > 
 ...
 <tr valign="baseline">
      ...
      <td width="400">
	  	 <input name="partition1" type="text"  placeholder="Partition 1">						
      </td>
      <td width="30" height="42" align="right" nowrap><div align="center" class="Style23">
          <div align="center" <span class="Style22">Partition 2: <span class="Style1"></span></div>
	  </div></td>
     <td width="200">
	  	 <input name="partition2" type="text"  placeholder="Partition 2">						
     </td>
    </tr>		
   <tr valign="baseline">
      <td width="30" height="42" align="right" nowrap ><div align="center" class="Style23">
      ...
      <td width="200">
	  	 <input name="partition3" type="text"  placeholder="Partition 3">						
      </td>
...
<tr valign="baseline">
  ...
  <div class="form-actions">
     ...
     <a class="btn" href="index_cust_choose.php?entities_id=<?php echo $entities_id; ?> &type=disks">Retour</a>
 </div>
